...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c" 2
...
# 139 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c" 2
# 202 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c"
HAL_StatusTypeDef HAL_RTC_Init(RTC_HandleTypeDef *hrtc)
{
  ...
  else
  {
    ...
    hrtc->Instance->OR &= (uint32_t)~(0x1U << (3U));
...
# 278 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c"
HAL_StatusTypeDef HAL_RTC_DeInit(RTC_HandleTypeDef *hrtc)
{
...
# 438 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c"
HAL_StatusTypeDef HAL_RTC_SetTime(RTC_HandleTypeDef *hrtc, RTC_TimeTypeDef *sTime, uint32_t Format)
{
  uint32_t tmpreg = 0;
  ...
  if(Format == 0x00000000U)
  {
    ...
    tmpreg = (uint32_t)(((uint32_t)RTC_ByteToBcd2(sTime->Hours) << 16) | ((uint32_t)RTC_ByteToBcd2(sTime->Minutes) << 8) | ((uint32_t)RTC_ByteToBcd2(sTime->Seconds)) | (((uint32_t)sTime->TimeFormat) << 16));
  ...
  else
  {
    ...
    ((void)0U);
    ((void)0U);
    tmpreg = (((uint32_t)(sTime->Hours) << 16) | ((uint32_t)(sTime->Minutes) << 8) | ((uint32_t)sTime->Seconds) | ((uint32_t)(sTime->TimeFormat) << 16));
...
# 573 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c"
HAL_StatusTypeDef HAL_RTC_GetTime(RTC_HandleTypeDef *hrtc, RTC_TimeTypeDef *sTime, uint32_t Format)
{
  uint32_t tmpreg = 0;
  ...
  sTime->Hours = (uint8_t)((tmpreg & ((0x3U << (20U)) | (0xFU << (16U)))) >> 16);
  sTime->Minutes = (uint8_t)((tmpreg & ((0x7U << (12U)) | (0xFU << (8U)))) >>8);
  sTime->Seconds = (uint8_t)(tmpreg & ((0x7U << (4U)) | (0xFU << (0U))));
  sTime->TimeFormat = (uint8_t)((tmpreg & ((0x1U << (22U)))) >> 16);
...
# 618 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c"
HAL_StatusTypeDef HAL_RTC_SetDate(RTC_HandleTypeDef *hrtc, RTC_DateTypeDef *sDate, uint32_t Format)
{
 ...
 do{ if((hrtc)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (hrtc)->Lock = HAL_LOCKED; } }while (0);
  ...
  if(Format == 0x00000000U)
  {
   ...
   datetmpreg = (((uint32_t)RTC_ByteToBcd2(sDate->Year) << 16) | ((uint32_t)RTC_ByteToBcd2(sDate->Month) << 8) | ((uint32_t)RTC_ByteToBcd2(sDate->Date)) | ((uint32_t)sDate->WeekDay << 13));
  ...
  else
  {
    ...
    datetmpreg = ((((uint32_t)sDate->Year) << 16) | (((uint32_t)sDate->Month) << 8) | ((uint32_t)sDate->Date) | (((uint32_t)sDate->WeekDay) << 13));
...
# 730 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c"
HAL_StatusTypeDef HAL_RTC_GetDate(RTC_HandleTypeDef *hrtc, RTC_DateTypeDef *sDate, uint32_t Format)
{
  uint32_t datetmpreg = 0;
  ...
  sDate->Year = (uint8_t)((datetmpreg & ((0xFU << (20U)) | (0xFU << (16U)))) >> 16);
  sDate->Month = (uint8_t)((datetmpreg & ((0x1U << (12U)) | (0xFU << (8U)))) >> 8);
  sDate->Date = (uint8_t)(datetmpreg & ((0x3U << (4U)) | (0xFU << (0U))));
  sDate->WeekDay = (uint8_t)((datetmpreg & ((0x7U << (13U)))) >> 13);
...
HAL_StatusTypeDef HAL_RTC_SetAlarm(RTC_HandleTypeDef *hrtc, RTC_AlarmTypeDef *sAlarm, uint32_t Format)
{
  ...
  if(Format == 0x00000000U)
  {
    ...
    tmpreg = (((uint32_t)RTC_ByteToBcd2(sAlarm->AlarmTime.Hours) << 16) | ((uint32_t)RTC_ByteToBcd2(sAlarm->AlarmTime.Minutes) << 8) | ((uint32_t)RTC_ByteToBcd2(sAlarm->AlarmTime.Seconds)) | ((uint32_t)(sAlarm->AlarmTime.TimeFormat) << 16) | ((uint32_t)RTC_ByteToBcd2(sAlarm->AlarmDateWeekDay) << 24) | ((uint32_t)sAlarm->AlarmDateWeekDaySel) | ((uint32_t)sAlarm->AlarmMask));
  ...
  else
  {
    ...
    tmpreg = (((uint32_t)(sAlarm->AlarmTime.Hours) << 16) | ((uint32_t)(sAlarm->AlarmTime.Minutes) << 8) | ((uint32_t) sAlarm->AlarmTime.Seconds) | ((uint32_t)(sAlarm->AlarmTime.TimeFormat) << 16) | ((uint32_t)(sAlarm->AlarmDateWeekDay) << 24) | ((uint32_t)sAlarm->AlarmDateWeekDaySel) | ((uint32_t)sAlarm->AlarmMask));
  ...
  if(sAlarm->Alarm == (0x1U << (8U)))
  {
    ...
    ((hrtc)->Instance->CR &= ~((0x1U << (12U))));


    tickstart = HAL_GetTick();


    while((((((hrtc)->Instance->ISR) & ((0x1U << (0U)))) != RESET)? SET : RESET) == RESET)
    {
      if((HAL_GetTick() - tickstart ) > 1000U)
      {
  ...
  else
  {
    ...
    ((hrtc)->Instance->CR &= ~((0x1U << (13U))));


    tickstart = HAL_GetTick();


    while((((((hrtc)->Instance->ISR) & ((0x1U << (1U)))) != RESET)? SET : RESET) == RESET)
    {
      if((HAL_GetTick() - tickstart ) > 1000U)
      {
...
HAL_StatusTypeDef HAL_RTC_SetAlarm_IT(RTC_HandleTypeDef *hrtc, RTC_AlarmTypeDef *sAlarm, uint32_t Format)
{
  ...
  if(sAlarm->Alarm == (0x1U << (8U)))
  {
    ...
    ((hrtc)->Instance->ISR) = (~((((0x1U << (8U))) | (0x1U << (7U)))& 0x0000FFFFU)|((hrtc)->Instance->ISR & (0x1U << (7U))));
  ...
  (((EXTI_TypeDef *) ((0x40000000U + 0x00010000U) + 0x3C00U))->IMR |= (0x1U << (17U)));

  ((EXTI_TypeDef *) ((0x40000000U + 0x00010000U) + 0x3C00U))->RTSR |= (0x1U << (17U));
...
# 1261 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c"
HAL_StatusTypeDef HAL_RTC_GetAlarm(RTC_HandleTypeDef *hrtc, RTC_AlarmTypeDef *sAlarm, uint32_t Alarm, uint32_t Format)
{
  uint32_t tmpreg = 0, subsecondtmpreg = 0;
  ...
  sAlarm->AlarmTime.Hours = (uint32_t)((tmpreg & ((0x3U << (20U)) | (0xFU << (16U)))) >> 16);
  sAlarm->AlarmTime.Minutes = (uint32_t)((tmpreg & ((0x7U << (12U)) | (0xFU << (8U)))) >> 8);
  sAlarm->AlarmTime.Seconds = (uint32_t)(tmpreg & ((0x7U << (4U)) | (0xFU << (0U))));
  sAlarm->AlarmTime.TimeFormat = (uint32_t)((tmpreg & (0x1U << (22U))) >> 16);
  sAlarm->AlarmTime.SubSeconds = (uint32_t) subsecondtmpreg;
  sAlarm->AlarmDateWeekDay = (uint32_t)((tmpreg & ((0x3U << (28U)) | (0xFU << (24U)))) >> 24);
...
void HAL_RTC_AlarmIRQHandler(RTC_HandleTypeDef* hrtc)
{
  if(((((((hrtc)->Instance->ISR)& (((0x1U << (12U)))>> 4U)) & 0x0000FFFFU) != RESET)? SET : RESET))
  {

    if((uint32_t)(hrtc->Instance->CR & (0x1U << (12U))) != (uint32_t)RESET)
    {
  ...
  if(((((((hrtc)->Instance->ISR)& (((0x1U << (13U)))>> 4U)) & 0x0000FFFFU) != RESET)? SET : RESET))
  {

    if((uint32_t)(hrtc->Instance->CR & (0x1U << (13U))) != (uint32_t)RESET)
    {
  ...
  (((EXTI_TypeDef *) ((0x40000000U + 0x00010000U) + 0x3C00U))->PR = (0x1U << (17U)));
...
HAL_StatusTypeDef HAL_RTC_PollForAlarmAEvent(RTC_HandleTypeDef *hrtc, uint32_t Timeout)
{
  ...
  while((((((hrtc)->Instance->ISR) & ((0x1U << (8U)))) != RESET)? SET : RESET) == RESET)
  {
