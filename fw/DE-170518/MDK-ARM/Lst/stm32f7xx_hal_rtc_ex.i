...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c" 2
# 99 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
...
# 100 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c" 2
# 157 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
HAL_StatusTypeDef HAL_RTCEx_SetTimeStamp(RTC_HandleTypeDef *hrtc, uint32_t TimeStampEdge, uint32_t RTC_TimeStampPin)
{
  uint32_t tmpreg = 0;
  ...
  do{ if((hrtc)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (hrtc)->Lock = HAL_LOCKED; } }while (0);
  ...
  hrtc->Instance->OR &= (uint32_t)~(0x3U << (1U));
  ...
  do{ (hrtc)->Lock = HAL_UNLOCKED; }while (0);

  return HAL_OK;
}
# 217 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
HAL_StatusTypeDef HAL_RTCEx_SetTimeStamp_IT(RTC_HandleTypeDef *hrtc, uint32_t TimeStampEdge, uint32_t RTC_TimeStampPin)
{
  uint32_t tmpreg = 0;
  ...
  ((hrtc)->Instance->ISR) = (~(((0x1U << (11U))) | (0x1U << (7U)))|((hrtc)->Instance->ISR & (0x1U << (7U))));

  ((hrtc)->Instance->CR |= ((0x1U << (11U))));


  ((hrtc)->Instance->CR |= ((0x1U << (15U))));
...
# 313 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
HAL_StatusTypeDef HAL_RTCEx_SetInternalTimeStamp(RTC_HandleTypeDef *hrtc)
{
...
# 380 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
HAL_StatusTypeDef HAL_RTCEx_GetTimeStamp(RTC_HandleTypeDef *hrtc, RTC_TimeTypeDef* sTimeStamp, RTC_DateTypeDef* sTimeStampDate, uint32_t Format)
{
  ...
  sTimeStamp->Hours = (uint8_t)((tmptime & ((0x3U << (20U)) | (0xFU << (16U)))) >> 16);
  sTimeStamp->Minutes = (uint8_t)((tmptime & ((0x7U << (12U)) | (0xFU << (8U)))) >> 8);
  sTimeStamp->Seconds = (uint8_t)(tmptime & ((0x7U << (4U)) | (0xFU << (0U))));
  sTimeStamp->TimeFormat = (uint8_t)((tmptime & ((0x1U << (22U)))) >> 16);
  sTimeStamp->SubSeconds = (uint32_t) hrtc->Instance->TSSSR;


  sTimeStampDate->Year = 0;
  sTimeStampDate->Month = (uint8_t)((tmpdate & ((0x1U << (12U)) | (0xFU << (8U)))) >> 8);
  sTimeStampDate->Date = (uint8_t)(tmpdate & ((0x3U << (4U)) | (0xFU << (0U))));
  sTimeStampDate->WeekDay = (uint8_t)((tmpdate & ((0x7U << (13U)))) >> 13);
...
HAL_StatusTypeDef HAL_RTCEx_SetTamper(RTC_HandleTypeDef *hrtc, RTC_TamperTypeDef* sTamper)
{
  ...
  if(sTamper->Trigger != ((uint32_t)0x00000000U))
  {
    sTamper->Trigger = (uint32_t)(sTamper->Tamper << 1);
  }

  if(sTamper->NoErase != ((uint32_t)0x00000000U))
  {
    sTamper->NoErase = 0;
    if((sTamper->Tamper & (0x1U << (0U))) != 0)
    {
      sTamper->NoErase |= (0x1U << (17U));
    }
    if((sTamper->Tamper & (0x1U << (3U))) != 0)
    {
      sTamper->NoErase |= (0x1U << (20U));
    }
    if((sTamper->Tamper & (0x1U << (5U))) != 0)
    {
      sTamper->NoErase |= (0x1U << (23U));
    }
  }

  if(sTamper->MaskFlag != ((uint32_t)0x00000000U))
  {
    sTamper->MaskFlag = 0;
    if((sTamper->Tamper & (0x1U << (0U))) != 0)
    {
      sTamper->MaskFlag |= (0x1U << (18U));
    }
    if((sTamper->Tamper & (0x1U << (3U))) != 0)
    {
      sTamper->MaskFlag |= (0x1U << (21U));
    }
    if((sTamper->Tamper & (0x1U << (5U))) != 0)
    {
      sTamper->MaskFlag |= (0x1U << (24U));
    }
  }

  tmpreg = ((uint32_t)sTamper->Tamper | (uint32_t)sTamper->Trigger | (uint32_t)sTamper->NoErase | (uint32_t)sTamper->MaskFlag | (uint32_t)sTamper->Filter | (uint32_t)sTamper->SamplingFrequency | (uint32_t)sTamper->PrechargeDuration | (uint32_t)sTamper->TamperPullUp | sTamper->TimeStampOnTamperDetection);



  hrtc->Instance->TAMPCR &= (uint32_t)~((uint32_t)sTamper->Tamper | (uint32_t)(sTamper->Tamper << 1) | (uint32_t)(0x1U << (7U)) | (uint32_t)(0x7U << (8U)) | (uint32_t)(0x3U << (11U)) | (uint32_t)(0x3U << (13U)) | (uint32_t)(0x1U << (15U)) | (uint32_t)(0x1U << (2U)) | (uint32_t)(0x1U << (16U)) | (uint32_t)(0x1U << (19U)) | (uint32_t)(0x1U << (22U)) | (uint32_t)(0x1U << (17U)) | (uint32_t)(0x1U << (20U)) | (uint32_t)(0x1U << (23U)) | (uint32_t)(0x1U << (18U)) | (uint32_t)(0x1U << (21U)) | (uint32_t)(0x1U << (24U)));
...
# 520 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
HAL_StatusTypeDef HAL_RTCEx_SetTamper_IT(RTC_HandleTypeDef *hrtc, RTC_TamperTypeDef* sTamper)
{
  uint32_t tmpreg = 0;
  ...
  tmpreg = ((uint32_t)sTamper->Tamper | (uint32_t)sTamper->Interrupt | (uint32_t)sTamper->Trigger | (uint32_t)sTamper->NoErase | (uint32_t)sTamper->MaskFlag | (uint32_t)sTamper->Filter | (uint32_t)sTamper->SamplingFrequency | (uint32_t)sTamper->PrechargeDuration | (uint32_t)sTamper->TamperPullUp | sTamper->TimeStampOnTamperDetection);
  ...
  if(sTamper->Tamper == (0x1U << (0U)))
  {
    ...
    ((hrtc)->Instance->ISR) = (~(((0x1U << (13U))) | (0x1U << (7U)))|((hrtc)->Instance->ISR & (0x1U << (7U))));
  }
  else if(sTamper->Tamper == (0x1U << (3U)))
  {

    ((hrtc)->Instance->ISR) = (~(((0x1U << (14U))) | (0x1U << (7U)))|((hrtc)->Instance->ISR & (0x1U << (7U))));
  }
  else
  {

    ((hrtc)->Instance->ISR) = (~(((0x1U << (15U))) | (0x1U << (7U)))|((hrtc)->Instance->ISR & (0x1U << (7U))));
  }
...
HAL_StatusTypeDef HAL_RTCEx_DeactivateTamper(RTC_HandleTypeDef *hrtc, uint32_t Tamper)
{
  ...
  if ((Tamper & (0x1U << (0U))) != 0)
  {
    ...
    hrtc->Instance->TAMPCR &= (uint32_t)~((0x1U << (2U)) | (0x1U << (16U)));
  }
  if ((Tamper & (0x1U << (3U))) != 0)
  {

    hrtc->Instance->TAMPCR &= (uint32_t)~((0x1U << (2U)) | (0x1U << (19U)));
  }
  if ((Tamper & (0x1U << (5U))) != 0)
  {

    hrtc->Instance->TAMPCR &= (uint32_t)~((0x1U << (2U)) | (0x1U << (22U)));
  }
...
void HAL_RTCEx_TamperTimeStampIRQHandler(RTC_HandleTypeDef *hrtc)
{
  if((((((hrtc)->Instance->ISR) & (((0x1U << (15U)))>> 4)) != RESET) ? SET : RESET))
  {

    if((uint32_t)(hrtc->Instance->CR & (0x1U << (15U))) != (uint32_t)RESET)
    {
  ...
  if((((((hrtc)->Instance->ISR) & ((0x1U << (13U)))) != RESET) ? SET : RESET)== SET)
  {

    if((((hrtc->Instance->TAMPCR & (0x1U << (2U)))) != (uint32_t)RESET) || (((hrtc->Instance->TAMPCR & (0x1U << (16U)))) != (uint32_t)RESET))
  ...
  if((((((hrtc)->Instance->ISR) & ((0x1U << (14U)))) != RESET) ? SET : RESET)== SET)
  {

    if((((hrtc->Instance->TAMPCR & (0x1U << (2U)))) != (uint32_t)RESET) || (((hrtc->Instance->TAMPCR & (0x1U << (19U)))) != (uint32_t)RESET))
  ...
  if((((((hrtc)->Instance->ISR) & ((0x1U << (15U)))) != RESET) ? SET : RESET)== SET)
  {

    if((((hrtc->Instance->TAMPCR & (0x1U << (2U)))) != (uint32_t)RESET) || (((hrtc->Instance->TAMPCR & (0x1U << (22U)))) != (uint32_t)RESET))
...
# 810 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
HAL_StatusTypeDef HAL_RTCEx_PollForTimeStampEvent(RTC_HandleTypeDef *hrtc, uint32_t Timeout)
{
  ...
  while((((((hrtc)->Instance->ISR) & ((0x1U << (11U)))) != RESET) ? SET : RESET) == RESET)
  {
  ...
  if((((((hrtc)->Instance->ISR) & ((0x1U << (12U)))) != RESET) ? SET : RESET) != RESET)
  {

    ((hrtc)->Instance->ISR) = (~(((0x1U << (12U))) | (0x1U << (7U)))|((hrtc)->Instance->ISR & (0x1U << (7U))));
...
# 853 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
HAL_StatusTypeDef HAL_RTCEx_PollForTamper1Event(RTC_HandleTypeDef *hrtc, uint32_t Timeout)
{
  uint32_t tickstart = 0;
  ...
  while((((((hrtc)->Instance->ISR) & ((0x1U << (13U)))) != RESET) ? SET : RESET)== RESET)
  {
    if(Timeout != 0xFFFFFFFFU)
    {
      if((Timeout == 0)||((HAL_GetTick() - tickstart ) > Timeout))
...
# 889 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
HAL_StatusTypeDef HAL_RTCEx_PollForTamper2Event(RTC_HandleTypeDef *hrtc, uint32_t Timeout)
{
  uint32_t tickstart = 0;
  ...
  while((((((hrtc)->Instance->ISR) & ((0x1U << (14U)))) != RESET) ? SET : RESET) == RESET)
  {
    if(Timeout != 0xFFFFFFFFU)
    {
      if((Timeout == 0)||((HAL_GetTick() - tickstart ) > Timeout))
...
HAL_StatusTypeDef HAL_RTCEx_PollForTamper3Event(RTC_HandleTypeDef *hrtc, uint32_t Timeout)
{
  ...
  while((((((hrtc)->Instance->ISR) & ((0x1U << (15U)))) != RESET) ? SET : RESET) == RESET)
  {
    if(Timeout != 0xFFFFFFFFU)
    {
      if((Timeout == 0)||((HAL_GetTick() - tickstart ) > Timeout))
...
# 976 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
HAL_StatusTypeDef HAL_RTCEx_SetWakeUpTimer(RTC_HandleTypeDef *hrtc, uint32_t WakeUpCounter, uint32_t WakeUpClock)
{
  uint32_t tickstart = 0;
  ...
  if((hrtc->Instance->CR & (0x1U << (10U))) != RESET)
  {
    ...
    while((((((hrtc)->Instance->ISR) & ((0x1U << (2U)))) != RESET) ? SET : RESET) == RESET)
    {
...
# 1049 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
HAL_StatusTypeDef HAL_RTCEx_SetWakeUpTimer_IT(RTC_HandleTypeDef *hrtc, uint32_t WakeUpCounter, uint32_t WakeUpClock)
{
  uint32_t tickstart = 0;
  ...
  ((hrtc)->Instance->ISR) = (~(((0x1U << (10U))) | (0x1U << (7U)))|((hrtc)->Instance->ISR & (0x1U << (7U))));


  ((hrtc)->Instance->CR |= ((0x1U << (14U))));
...
void HAL_RTCEx_WakeUpTimerIRQHandler(RTC_HandleTypeDef *hrtc)
{
  if((((((hrtc)->Instance->ISR) & (((0x1U << (14U)))>> 4)) != RESET) ? SET : RESET))
  {

    if((uint32_t)(hrtc->Instance->CR & (0x1U << (14U))) != (uint32_t)RESET)
    {
...
HAL_StatusTypeDef HAL_RTCEx_PollForWakeUpTimerEvent(RTC_HandleTypeDef *hrtc, uint32_t Timeout)
{
  ...
  while((((((hrtc)->Instance->ISR) & ((0x1U << (10U)))) != RESET) ? SET : RESET) == RESET)
  {
    if(Timeout != 0xFFFFFFFFU)
    {
      if((Timeout == 0)||((HAL_GetTick() - tickstart ) > Timeout))
...
# 1313 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
void HAL_RTCEx_BKUPWrite(RTC_HandleTypeDef *hrtc, uint32_t BackupRegister, uint32_t Data)
{
  uint32_t tmp = 0;
...
# 1706 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
HAL_StatusTypeDef HAL_RTCEx_EnableBypassShadow(RTC_HandleTypeDef* hrtc)
{
...
HAL_StatusTypeDef HAL_RTCEx_PollForAlarmBEvent(RTC_HandleTypeDef *hrtc, uint32_t Timeout)
{
  ...
  while((((((hrtc)->Instance->ISR) & ((0x1U << (9U)))) != RESET)? SET : RESET) == RESET)
  {
    if(Timeout != 0xFFFFFFFFU)
    {
      if((Timeout == 0)||((HAL_GetTick() - tickstart ) > Timeout))
  ...
  ((hrtc)->Instance->ISR) = (~((((0x1U << (9U))) | (0x1U << (7U)))& 0x0000FFFFU)|((hrtc)->Instance->ISR & (0x1U << (7U))));
