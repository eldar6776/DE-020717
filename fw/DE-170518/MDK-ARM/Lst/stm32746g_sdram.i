# 1 "../Drivers/BSP/STM32F746/stm32746g_sdram.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 370 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/BSP/STM32F746/stm32746g_sdram.c" 2
# 86 "../Drivers/BSP/STM32F746/stm32746g_sdram.c"
# 1 "../Drivers/BSP/STM32F746/stm32746g_sdram.h" 1
# 46 "../Drivers/BSP/STM32F746/stm32746g_sdram.h"
...
# 47 "../Drivers/BSP/STM32F746/stm32746g_sdram.h" 2
...
# 87 "../Drivers/BSP/STM32F746/stm32746g_sdram.c" 2
# 124 "../Drivers/BSP/STM32F746/stm32746g_sdram.c"
SDRAM_HandleTypeDef sdramHandle;
static FMC_SDRAM_TimingTypeDef Timing;
static FMC_SDRAM_CommandTypeDef Command;
# 146 "../Drivers/BSP/STM32F746/stm32746g_sdram.c"
uint8_t SDRAM_Init(void)
{
  static uint8_t sdramstatus = ((uint8_t)0x01);

  sdramHandle.Instance = ((FMC_Bank5_6_TypeDef *) (0xA0000000U + 0x0140U));


  Timing.LoadToActiveDelay = 4;
  ...
  sdramHandle.Init.SDBank = ((uint32_t)0x00000000U);
  sdramHandle.Init.ColumnBitsNumber = ((uint32_t)0x00000000U);
  sdramHandle.Init.RowBitsNumber = ((uint32_t)0x00000004U);
  sdramHandle.Init.MemoryDataWidth = ((uint32_t)0x00000010U);
  sdramHandle.Init.InternalBankNumber = ((uint32_t)0x00000040U);
  sdramHandle.Init.CASLatency = ((uint32_t)0x00000100U);
  sdramHandle.Init.WriteProtection = ((uint32_t)0x00000000U);
  sdramHandle.Init.SDClockPeriod = ((uint32_t)0x00000800U);
  sdramHandle.Init.ReadBurst = ((uint32_t)0x00001000U);
  sdramHandle.Init.ReadPipeDelay = ((uint32_t)0x00000000U);



  BSP_SDRAM_MspInit(&sdramHandle, 0);

  if(HAL_SDRAM_Init(&sdramHandle, &Timing) != HAL_OK)
  {
    sdramstatus = ((uint8_t)0x01);
  }
  else
  {
    sdramstatus = ((uint8_t)0x00);
  }
...
void BSP_SDRAM_Initialization_sequence(uint32_t RefreshCount)
{
  ...
  Command.CommandMode = ((uint32_t)0x00000001U);
  Command.CommandTarget = (0x1U << (4U));
  ...
  Command.CommandMode = ((uint32_t)0x00000002U);
  Command.CommandTarget = (0x1U << (4U));
  Command.AutoRefreshNumber = 1;
  Command.ModeRegisterDefinition = 0;
  ...
  Command.CommandMode = ((uint32_t)0x00000003U);
  Command.CommandTarget = (0x1U << (4U));
  ...
  tmpmrd = (uint32_t)((uint16_t)0x0000) | ((uint16_t)0x0000) | ((uint16_t)0x0020) | ((uint16_t)0x0000) | ((uint16_t)0x0200);





  Command.CommandMode = ((uint32_t)0x00000004U);
  Command.CommandTarget = (0x1U << (4U));
  Command.AutoRefreshNumber = 1;
...
# 283 "../Drivers/BSP/STM32F746/stm32746g_sdram.c"
uint8_t BSP_SDRAM_ReadData(uint32_t uwStartAddress, uint32_t *pData, uint32_t uwDataSize)
{
...
# 302 "../Drivers/BSP/STM32F746/stm32746g_sdram.c"
uint8_t BSP_SDRAM_ReadData_DMA(uint32_t uwStartAddress, uint32_t *pData, uint32_t uwDataSize)
{
...
# 321 "../Drivers/BSP/STM32F746/stm32746g_sdram.c"
uint8_t BSP_SDRAM_WriteData(uint32_t uwStartAddress, uint32_t *pData, uint32_t uwDataSize)
{
...
# 340 "../Drivers/BSP/STM32F746/stm32746g_sdram.c"
uint8_t BSP_SDRAM_WriteData_DMA(uint32_t uwStartAddress, uint32_t *pData, uint32_t uwDataSize)
{
...
uint8_t BSP_SDRAM_Sendcmd(FMC_SDRAM_CommandTypeDef *SdramCmd)
{
  if(HAL_SDRAM_SendCommand(&sdramHandle, SdramCmd, ((uint32_t)0xFFFF)) != HAL_OK)
  {
    return ((uint8_t)0x01);
  }
  else
...
__attribute__((weak)) void BSP_SDRAM_MspInit(SDRAM_HandleTypeDef *hsdram, void *Params)
{
  static DMA_HandleTypeDef dma_handle;
  GPIO_InitTypeDef GPIO_InitStruct;


  do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB3ENR) |= ((0x1U << (0U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB3ENR) & ((0x1U << (0U)))); ((void)(tmpreg)); } while(0);


  do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) |= ((0x1U << (22U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) & ((0x1U << (22U)))); ((void)(tmpreg)); } while(0);
...
# 434 "../Drivers/BSP/STM32F746/stm32746g_sdram.c"
 GPIO_InitStruct.Pin = ((uint16_t)0x0001U)|((uint16_t)0x0002U)|((uint16_t)0x0004U)|((uint16_t)0x0008U)
        |((uint16_t)0x0010U)|((uint16_t)0x0020U)|((uint16_t)0x0800U)|((uint16_t)0x1000U)
        |((uint16_t)0x2000U)|((uint16_t)0x4000U)|((uint16_t)0x8000U);
 ...
 GPIO_InitStruct.Alternate = ((uint8_t)0xCU);
 ...
 GPIO_InitStruct.Pin = ((uint16_t)0x0001U)|((uint16_t)0x0002U)|((uint16_t)0x0010U)|((uint16_t)0x0020U)
        |((uint16_t)0x0100U)|((uint16_t)0x8000U);
 GPIO_InitStruct.Mode = ((uint32_t)0x00000002U);
 GPIO_InitStruct.Pull = ((uint32_t)0x00000000U);
 GPIO_InitStruct.Speed = ((uint32_t)0x00000003U);
 GPIO_InitStruct.Alternate = ((uint8_t)0xCU);
 ...
 GPIO_InitStruct.Pin = ((uint16_t)0x0080U)|((uint16_t)0x0100U)|((uint16_t)0x0200U)|((uint16_t)0x0400U)
        |((uint16_t)0x0800U)|((uint16_t)0x1000U)|((uint16_t)0x2000U)|((uint16_t)0x4000U)
        |((uint16_t)0x8000U)|((uint16_t)0x0001U)|((uint16_t)0x0002U);
 GPIO_InitStruct.Mode = ((uint32_t)0x00000002U);
 GPIO_InitStruct.Pull = ((uint32_t)0x00000000U);
 GPIO_InitStruct.Speed = ((uint32_t)0x00000003U);
 GPIO_InitStruct.Alternate = ((uint8_t)0xCU);
 ...
 GPIO_InitStruct.Pin = ((uint16_t)0x0100U)|((uint16_t)0x0200U)|((uint16_t)0x0400U)|((uint16_t)0x4000U)
        |((uint16_t)0x8000U)|((uint16_t)0x0001U)|((uint16_t)0x0002U);
 GPIO_InitStruct.Mode = ((uint32_t)0x00000002U);
 GPIO_InitStruct.Pull = ((uint32_t)0x00000000U);
 GPIO_InitStruct.Speed = ((uint32_t)0x00000003U);
 ...
 dma_handle.Init.Channel = ((uint32_t)0x00000000U);
 dma_handle.Init.Direction = ((uint32_t)(0x2U << (6U)));
 dma_handle.Init.PeriphInc = ((uint32_t)(0x1U << (9U)));
 dma_handle.Init.MemInc = ((uint32_t)(0x1U << (10U)));
 dma_handle.Init.PeriphDataAlignment = ((uint32_t)(0x2U << (11U)));
 dma_handle.Init.MemDataAlignment = ((uint32_t)(0x2U << (13U)));
 dma_handle.Init.Mode = ((uint32_t)0x00000000U);
 dma_handle.Init.Priority = ((uint32_t)(0x2U << (16U)));
 dma_handle.Init.FIFOMode = ((uint32_t)0x00000000U);
 dma_handle.Init.FIFOThreshold = ((uint32_t)(0x3U << (0U)));
 dma_handle.Init.MemBurst = ((uint32_t)0x00000000U);
 dma_handle.Init.PeriphBurst = ((uint32_t)0x00000000U);

 dma_handle.Instance = ((DMA_Stream_TypeDef *) (((0x40000000U + 0x00020000U) + 0x6400U) + 0x010U));


 do{ (hsdram)->hdma = &(dma_handle); (dma_handle).Parent = (hsdram); } while(0);
...
__attribute__((weak)) void BSP_SDRAM_MspDeInit(SDRAM_HandleTypeDef *hsdram, void *Params)
{
    static DMA_HandleTypeDef dma_handle;
