...
# 65 "../Src/system_stm32f7xx.c" 2
# 126 "../Src/system_stm32f7xx.c"
  uint32_t SystemCoreClock = 16000000;
  const uint8_t AHBPrescTable[16] = {0, 0, 0, 0, 0, 0, 0, 0, 1, 2, 3, 4, 6, 7, 8, 9};
  const uint8_t APBPrescTable[8] = {0, 0, 0, 0, 1, 2, 3, 4};
# 156 "../Src/system_stm32f7xx.c"
  ...
  switch (tmp)
  {
    ...
    case 0x08:
      ...
      if (pllsource != 0)
      {
        ...
        pllvco = (((uint32_t)8000000) / pllm) * ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->PLLCFGR & (0x1FFU << (6U))) >> 6);
      }
      else
      {

        pllvco = (((uint32_t)16000000) / pllm) * ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->PLLCFGR & (0x1FFU << (6U))) >> 6);
      }
