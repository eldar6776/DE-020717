...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_uart.c" 2
...
# 156 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_uart.c" 2
...
# 241 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_uart.c"
HAL_StatusTypeDef HAL_UART_Init(UART_HandleTypeDef *huart)
{
...
# 1850 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_uart.c"
  ...
  if (huart->Init.OverSampling == ((uint32_t)(0x1U << (15U))))
  {
    ...
    case UART_CLOCKSOURCE_HSI:
        usartdiv = (uint16_t)(((((((uint32_t)16000000))*2)+((huart->Init.BaudRate)/2))/((huart->Init.BaudRate))));
      break;
    case UART_CLOCKSOURCE_SYSCLK:
        usartdiv = (uint16_t)(((((HAL_RCC_GetSysClockFreq())*2)+((huart->Init.BaudRate)/2))/((huart->Init.BaudRate))));
      break;
    case UART_CLOCKSOURCE_LSE:
        usartdiv = (uint16_t)(((((((uint32_t)32768))*2)+((huart->Init.BaudRate)/2))/((huart->Init.BaudRate))));
      break;
  ...
  else
  {
    ...
    case UART_CLOCKSOURCE_PCLK2:
      ...
      break;
    case UART_CLOCKSOURCE_HSI:
        huart->Instance->BRR = (uint16_t)(((((((uint32_t)16000000)))+((huart->Init.BaudRate)/2))/((huart->Init.BaudRate))));
      break;
    case UART_CLOCKSOURCE_SYSCLK:
        huart->Instance->BRR = (uint16_t)(((((HAL_RCC_GetSysClockFreq()))+((huart->Init.BaudRate)/2))/((huart->Init.BaudRate))));
      break;
    case UART_CLOCKSOURCE_LSE:
        huart->Instance->BRR = (uint16_t)(((((((uint32_t)32768)))+((huart->Init.BaudRate)/2))/((huart->Init.BaudRate))));
      break;
      case UART_CLOCKSOURCE_UNDEFINED:
    default:
        ret = HAL_ERROR;
