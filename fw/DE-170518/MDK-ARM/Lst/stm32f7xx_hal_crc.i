...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_crc.c" 2
...
# 67 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_crc.c" 2
# 84 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_crc.c"
static uint32_t CRC_Handle_8(CRC_HandleTypeDef *hcrc, uint8_t pBuffer[], uint32_t BufferLength);
static uint32_t CRC_Handle_16(CRC_HandleTypeDef *hcrc, uint16_t pBuffer[], uint32_t BufferLength);
# 116 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_crc.c"
HAL_StatusTypeDef HAL_CRC_Init(CRC_HandleTypeDef *hcrc)
{
  ...
  if(hcrc->Init.DefaultPolynomialUse == ((uint8_t)0x00U))
  {
    ...
    (((hcrc->Instance->CR)) = ((((((hcrc->Instance->CR))) & (~((0x3U << (3U))))) | (((uint32_t)0x00000000U)))));
  }
  else
  {
  ...
  ((void)0U);
  (((hcrc->Instance->CR)) = ((((((hcrc->Instance->CR))) & (~((0x3U << (5U))))) | (hcrc->Init.InputDataInversionMode))));


  ((void)0U);
  (((hcrc->Instance->CR)) = ((((((hcrc->Instance->CR))) & (~((0x1U << (7U))))) | (hcrc->Init.OutputDataInversionMode))));
...
# 359 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_crc.c"
uint32_t HAL_CRC_Calculate(CRC_HandleTypeDef *hcrc, uint32_t pBuffer[], uint32_t BufferLength)
{
  uint32_t index = 0;
  uint32_t temp = 0;
...
static uint32_t CRC_Handle_8(CRC_HandleTypeDef *hcrc, uint8_t pBuffer[], uint32_t BufferLength)
{
  uint32_t i = 0;
   ...
   if((BufferLength%4) != 0)
   {
     if(BufferLength%4 == 1)
     {
       *(volatile uint8_t*) (&hcrc->Instance->DR) = pBuffer[4*i];
     }
     if(BufferLength%4 == 2)
     {
       *(volatile uint16_t*) (&hcrc->Instance->DR) = (uint16_t)((uint16_t)((uint16_t)(pBuffer[4*i])<<8) | (uint16_t)(pBuffer[4*i+1]));
     }
     if(BufferLength%4 == 3)
     {
       *(volatile uint16_t*) (&hcrc->Instance->DR) = (uint16_t)((uint16_t)((uint16_t)(pBuffer[4*i])<<8) | (uint16_t)(pBuffer[4*i+1]));
       *(volatile uint8_t*) (&hcrc->Instance->DR) = pBuffer[4*i+2];
     }
   }
...
# 457 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_crc.c"
static uint32_t CRC_Handle_16(CRC_HandleTypeDef *hcrc, uint16_t pBuffer[], uint32_t BufferLength)
{
  uint32_t i = 0;
  ...
  if((BufferLength%2) != 0)
  {
     *(volatile uint16_t*) (&hcrc->Instance->DR) = pBuffer[2*i];
  }


  return hcrc->Instance->DR;
}
# 501 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_crc.c"
HAL_CRC_StateTypeDef HAL_CRC_GetState(CRC_HandleTypeDef *hcrc)
{
  return hcrc->State;
}
