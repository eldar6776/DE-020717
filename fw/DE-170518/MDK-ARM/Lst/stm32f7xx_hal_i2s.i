# 1 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_i2s.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 370 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_i2s.c" 2
# 138 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_i2s.c"
...
# 139 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_i2s.c" 2
# 159 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_i2s.c"
...
# 214 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_i2s.c"
HAL_StatusTypeDef HAL_I2S_Init(I2S_HandleTypeDef *hi2s)
{
  ...
  if(hi2s->Init.AudioFreq == ((uint32_t)2U))
  {
    i2sodd = (uint16_t)0;
    i2sdiv = (uint16_t)2;
  }
  ...
  else
  {
    ...
    if(hi2s->Init.DataFormat == ((uint32_t)0x00000000U))
    {
    ...
    if(hi2s->Init.ClockSource == ((uint32_t)0x00000001U))
    {
   ...
   i2sclk = I2S_GetClockFreq(hi2s);
    ...
    if(hi2s->Init.MCLKOutput == ((uint32_t)(0x1U << (9U))))
    {
  ...
  hi2s->ErrorCode = ((uint32_t)0x00000000U);
...
# 465 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_i2s.c"
HAL_StatusTypeDef HAL_I2S_Transmit(I2S_HandleTypeDef *hi2s, uint16_t *pData, uint16_t Size, uint32_t Timeout)
{
  if((pData == 0 ) || (Size == 0))
  {
  ...
  {
    if(((hi2s->Instance->I2SCFGR & ((0x3U << (1U)) | (0x1U << (0U)))) == ((uint32_t)0x00000003U))|| ((hi2s->Instance->I2SCFGR & ((0x3U << (1U)) | (0x1U << (0U)))) == ((uint32_t)0x00000005U)))
    ...
    while(hi2s->TxXferCount > 0)
    {
      ...
      if (I2S_WaitFlagStateUntilTimeout(hi2s, (0x1U << (1U)), SET, Timeout) != HAL_OK)
      {
        ...
        hi2s->ErrorCode |= ((uint32_t)0x00000001U);
      ...
      if(((((hi2s)->Instance->SR) & ((0x1U << (3U)))) == ((0x1U << (3U)))) == SET)
      {
        ...
        hi2s->ErrorCode |= ((uint32_t)0x00000004U);
        HAL_I2S_ErrorCallback(hi2s);
    ...
    if(((hi2s->Instance->I2SCFGR & (0x3U << (8U))) == ((uint32_t)0x00000000U)) || ((hi2s->Instance->I2SCFGR & (0x3U << (8U))) == ((uint32_t)0x00000100U)))
    {

      if (I2S_WaitFlagStateUntilTimeout(hi2s, (0x1U << (7U)), SET, Timeout) != HAL_OK)
      {
...
# 572 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_i2s.c"
HAL_StatusTypeDef HAL_I2S_Receive(I2S_HandleTypeDef *hi2s, uint16_t *pData, uint16_t Size, uint32_t Timeout)
{
  if((pData == 0 ) || (Size == 0))
  {
  ...
  if(hi2s->State == HAL_I2S_STATE_READY)
  {
    ...
    if((hi2s->Instance->I2SCFGR & (0x3U << (8U))) == ((uint32_t)0x00000300U))
    {
    ...
    while(hi2s->RxXferCount > 0)
    {
      ...
      if(((((hi2s)->Instance->SR) & ((0x1U << (6U)))) == ((0x1U << (6U)))) == SET)
      {
        ...
        hi2s->ErrorCode |= ((uint32_t)0x00000002U);
        HAL_I2S_ErrorCallback(hi2s);
...
# 672 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_i2s.c"
HAL_StatusTypeDef HAL_I2S_Transmit_IT(I2S_HandleTypeDef *hi2s, uint16_t *pData, uint16_t Size)
{
  if(hi2s->State == HAL_I2S_STATE_READY)
  {
...
# 737 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_i2s.c"
HAL_StatusTypeDef HAL_I2S_Receive_IT(I2S_HandleTypeDef *hi2s, uint16_t *pData, uint16_t Size)
{
  if(hi2s->State == HAL_I2S_STATE_READY)
  {
...
# 799 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_i2s.c"
HAL_StatusTypeDef HAL_I2S_Transmit_DMA(I2S_HandleTypeDef *hi2s, uint16_t *pData, uint16_t Size)
{
  uint32_t *tmp;
...
# 877 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_i2s.c"
HAL_StatusTypeDef HAL_I2S_Receive_DMA(I2S_HandleTypeDef *hi2s, uint16_t *pData, uint16_t Size)
{
  uint32_t *tmp;
...
HAL_StatusTypeDef HAL_I2S_DMAPause(I2S_HandleTypeDef *hi2s)
{
  ...
  if(hi2s->State == HAL_I2S_STATE_BUSY_TX)
  {
    ...
    hi2s->Instance->CR2 &= (uint32_t)(~(0x1U << (1U)));
  }
  else if(hi2s->State == HAL_I2S_STATE_BUSY_RX)
  {

    hi2s->Instance->CR2 &= (uint32_t)(~(0x1U << (0U)));
  }
  else if(hi2s->State == HAL_I2S_STATE_BUSY_TX_RX)
  {
    if((hi2s->Init.Mode == ((uint32_t)0x00000000U))||(hi2s->Init.Mode == ((uint32_t)0x00000200U)))
    {
...
HAL_StatusTypeDef HAL_I2S_DMAResume(I2S_HandleTypeDef *hi2s)
{
  ...
  if((((hi2s->Instance->I2SCFGR) & ((0x1U << (10U)))) == RESET))
  {
...
HAL_StatusTypeDef HAL_I2S_DMAStop(I2S_HandleTypeDef *hi2s)
{
  ...
  if(hi2s->hdmatx != 0)
  {
    ...
    ((hi2s->hdmatx)->Instance->CR &= ~(0x1U << (0U)));
  ...
  if(hi2s->hdmarx != 0)
  {
    ...
    ((hi2s->hdmarx)->Instance->CR &= ~(0x1U << (0U)));
...
# 1141 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_i2s.c"
...
# 1207 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_i2s.c"
...
# 1306 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_i2s.c"
HAL_I2S_StateTypeDef HAL_I2S_GetState(I2S_HandleTypeDef *hi2s)
{
  return hi2s->State;
}
...
# 1335 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_i2s.c"
static uint32_t I2S_GetClockFreq(I2S_HandleTypeDef *hi2s)
{
  uint32_t tmpreg = 0;
  ...
  switch(hi2s->Init.ClockSource)
  {
    case ((uint32_t)0x00000002U) :
    {
      ...
      if((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->PLLCFGR & (0x1U << (22U))) == 0x00000000U)
      {
        ...
        vcoinput = (((uint32_t)16000000) / (uint32_t)(((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->PLLCFGR & (0x3FU << (0U))));
      }
      else
      {

        vcoinput = ((((uint32_t)8000000) / (uint32_t)(((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->PLLCFGR & (0x3FU << (0U)))));
      }



      tmpreg = (((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->PLLI2SCFGR & (0x7U << (28U))) >> 28;
      i2sclocksource = (vcoinput * ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->PLLI2SCFGR & (0x1FFU << (6U))) >> 6))/(tmpreg);
...
# 1394 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_i2s.c"
static void I2S_DMATxCplt(DMA_HandleTypeDef *hdma)
{
...
static void I2S_DMAError(DMA_HandleTypeDef *hdma)
{
  ...
  hi2s->Instance->CR2 &= (uint32_t)(~((0x1U << (0U)) | (0x1U << (1U))));
  hi2s->TxXferCount = 0;
  hi2s->RxXferCount = 0;
  ...
  hi2s->ErrorCode |= ((uint32_t)0x00000008U);
  HAL_I2S_ErrorCallback(hi2s);
}
