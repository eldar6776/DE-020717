...
# 71 "C:\\Keil\\ARM\\ARMCLANG\\Bin\\..\\include\\stddef.h" 3
...
# 61 "../Middlewares/ST/STemWin/inc\\GUI_Private.h" 2
...
# 18 "../Src/LCDConf.c" 2
# 1 "../Middlewares/ST/STemWin/inc\\GUIDRV_Lin.h" 1
# 67 "../Middlewares/ST/STemWin/inc\\GUIDRV_Lin.h"
extern const GUI_DEVICE_API GUIDRV_Win_API;
...
# 20 "../Src/LCDConf.c" 2
# 419 "../Src/LCDConf.c"
static const unsigned long _aAddr[2] = {
  0xC0000000,

  0xC0000000 + (480 * 272 * 2 * 1 * 1)

};

static int _aPendingBuffer[2] = { -1, -1};
static int _aBufferIndex[2];
static int _axSize[2];
static int _aySize[2];
static int _aBytesPerPixels[2];




static void _DMA_Index2ColorBulk(void * pIndex, LCD_COLOR * pColor, unsigned long NumItems, unsigned char SizeOfIndex, unsigned long PixelFormat);
static void _DMA_Color2IndexBulk(LCD_COLOR * pColor, void * pIndex, unsigned long NumItems, unsigned char SizeOfIndex, unsigned long PixelFormat);




static void _Color2IndexBulk_M8888I_DMA2D(LCD_COLOR * pColor, void * pIndex, unsigned long NumItems, unsigned char SizeOfIndex) { _DMA_Color2IndexBulk(pColor, pIndex, NumItems, SizeOfIndex, ((uint32_t)0x00000000U)); } static void _Index2ColorBulk_M8888I_DMA2D(void * pIndex, LCD_COLOR * pColor, unsigned long NumItems, unsigned char SizeOfIndex) { _DMA_Index2ColorBulk(pIndex, pColor, NumItems, SizeOfIndex, ((uint32_t)0x00000000U)); }
static void _Color2IndexBulk_M888_DMA2D(LCD_COLOR * pColor, void * pIndex, unsigned long NumItems, unsigned char SizeOfIndex) { _DMA_Color2IndexBulk(pColor, pIndex, NumItems, SizeOfIndex, ((uint32_t)0x00000000U)); } static void _Index2ColorBulk_M888_DMA2D(void * pIndex, LCD_COLOR * pColor, unsigned long NumItems, unsigned char SizeOfIndex) { _DMA_Index2ColorBulk(pIndex, pColor, NumItems, SizeOfIndex, ((uint32_t)0x00000000U)); }
static void _Color2IndexBulk_M565_DMA2D(LCD_COLOR * pColor, void * pIndex, unsigned long NumItems, unsigned char SizeOfIndex) { _DMA_Color2IndexBulk(pColor, pIndex, NumItems, SizeOfIndex, ((uint32_t)0x00000002U)); } static void _Index2ColorBulk_M565_DMA2D(void * pIndex, LCD_COLOR * pColor, unsigned long NumItems, unsigned char SizeOfIndex) { _DMA_Index2ColorBulk(pIndex, pColor, NumItems, SizeOfIndex, ((uint32_t)0x00000002U)); }
static void _Color2IndexBulk_M1555I_DMA2D(LCD_COLOR * pColor, void * pIndex, unsigned long NumItems, unsigned char SizeOfIndex) { _DMA_Color2IndexBulk(pColor, pIndex, NumItems, SizeOfIndex, ((uint32_t)0x00000003U)); } static void _Index2ColorBulk_M1555I_DMA2D(void * pIndex, LCD_COLOR * pColor, unsigned long NumItems, unsigned char SizeOfIndex) { _DMA_Index2ColorBulk(pIndex, pColor, NumItems, SizeOfIndex, ((uint32_t)0x00000003U)); }
static void _Color2IndexBulk_M4444I_DMA2D(LCD_COLOR * pColor, void * pIndex, unsigned long NumItems, unsigned char SizeOfIndex) { _DMA_Color2IndexBulk(pColor, pIndex, NumItems, SizeOfIndex, ((uint32_t)0x00000004U)); } static void _Index2ColorBulk_M4444I_DMA2D(void * pIndex, LCD_COLOR * pColor, unsigned long NumItems, unsigned char SizeOfIndex) { _DMA_Index2ColorBulk(pIndex, pColor, NumItems, SizeOfIndex, ((uint32_t)0x00000004U)); }



static unsigned long _aBuffer[480 * sizeof(unsigned long) * 3];
static unsigned long * _pBuffer_DMA2D = &_aBuffer[480 * sizeof(unsigned long) * 0];
static unsigned long * _pBuffer_FG = &_aBuffer[480 * sizeof(unsigned long) * 1];
static unsigned long * _pBuffer_BG = &_aBuffer[480 * sizeof(unsigned long) * 2];
...
# 486 "../Src/LCDConf.c"
static unsigned long _GetPixelformat(int LayerIndex)
{
 const LCD_API_COLOR_CONV * pColorConvAPI;

 if (LayerIndex >= (sizeof(_apColorConvAPI) / sizeof(_apColorConvAPI[0])))
 {
  return 0;
 }
 ...
 if (pColorConvAPI == &LCD_API_ColorConv_M8888I) return ((uint32_t)0x00000000U);
 else if (pColorConvAPI == &LCD_API_ColorConv_M888) return ((uint32_t)0x00000001U);
 else if (pColorConvAPI == &LCD_API_ColorConv_M565) return ((uint32_t)0x00000002U);
 else if (pColorConvAPI == &LCD_API_ColorConv_M1555I) return ((uint32_t)0x00000003U);
 else if (pColorConvAPI == &LCD_API_ColorConv_M4444I) return ((uint32_t)0x00000004U);
 else if (pColorConvAPI == &LCD_API_ColorConv_8666) return ((uint32_t)0x00000005U);
 else if (pColorConvAPI == &LCD_API_ColorConv_1616I) return ((uint32_t)0x00000006U);
 else if (pColorConvAPI == &LCD_API_ColorConv_88666I) return ((uint32_t)0x00000007U);
...
{
 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->CR |= (0x1U << (0U));
 while (((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->CR & (0x1U << (0U)))
 {
  __builtin_arm_wfi();
 }
}
...
static void _DMA_Copy(int LayerIndex, void * pSrc, void * pDst, int xSize, int ySize, int OffLineSrc, int OffLineDst)
{
 ...
 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->CR = 0x00000000UL | (1 << 9);
 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->FGMAR = (unsigned long)pSrc;
 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->OMAR = (unsigned long)pDst;
 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->FGOR = OffLineSrc;
 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->OOR = OffLineDst;
 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->FGPFCCR = PixelFormat;
 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->NLR = (unsigned long)(xSize << 16) | (unsigned short)ySize;
 _DMA_ExecOperation();
}
...
static void _DMA_Fill(int LayerIndex, void * pDst, int xSize, int ySize, int OffLine, unsigned long ColorIndex)
{
 unsigned long PixelFormat;
 ...
 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->CR = 0x00030000UL | (1 << 9);
 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->OCOLR = ColorIndex;
 ...
 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->OOR = OffLine;



 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->OPFCCR = PixelFormat;
...
static void _DMA_AlphaBlendingBulk(LCD_COLOR * pColorFG, LCD_COLOR * pColorBG, LCD_COLOR * pColorDst, unsigned long NumItems)
{



 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->CR = 0x00020000UL | (1 << 9);



 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->FGMAR = (unsigned long)pColorFG;
 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->BGMAR = (unsigned long)pColorBG;
 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->OMAR = (unsigned long)pColorDst;



 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->FGOR = 0;
 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->BGOR = 0;
 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->OOR = 0;



 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->FGPFCCR = ((uint32_t)0x00000000U);
 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->BGPFCCR = ((uint32_t)0x00000000U);
 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->OPFCCR = ((uint32_t)0x00000000U);



 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->NLR = (unsigned long)(NumItems << 16) | 1;
...
# 623 "../Src/LCDConf.c"
static LCD_COLOR _DMA_MixColors(LCD_COLOR Color, LCD_COLOR BkColor, unsigned char Intens)
{
 ...
 *_pBuffer_BG = BkColor ^ 0xFF000000;
 ...
 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->FGMAR = (unsigned long)_pBuffer_FG;
 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->BGMAR = (unsigned long)_pBuffer_BG;
 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->OMAR = (unsigned long)_pBuffer_DMA2D;



 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->FGPFCCR = ((uint32_t)0x00000000U)
     | (1UL << 16)
     | ((unsigned long)Intens << 24);
 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->BGPFCCR = ((uint32_t)0x00000000U)
     | (0UL << 16)
     | ((unsigned long)(255 - Intens) << 24);
 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->OPFCCR = ((uint32_t)0x00000000U);



 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->NLR = (unsigned long)(1 << 16) | 1;
...
static void _DMA_MixColorsBulk(LCD_COLOR * pColorFG, LCD_COLOR * pColorBG, LCD_COLOR * pColorDst, unsigned char Intens, unsigned long NumItems)
{
...
static void _DMA_ConvertColor(void * pSrc, void * pDst, unsigned long PixelFormatSrc, unsigned long PixelFormatDst, unsigned long NumItems)
{



 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->CR = 0x00010000UL | (1 << 9);
 ...
 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->FGPFCCR = PixelFormatSrc;
 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->OPFCCR = PixelFormatDst;
...
static void _DMA_DrawBitmapL8(void * pSrc, void * pDst, unsigned long OffSrc, unsigned long OffDst, unsigned long PixelFormatDst, unsigned long xSize, unsigned long ySize)
{
 ...
 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->FGOR = OffSrc;
 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->OOR = OffDst;



 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->FGPFCCR = ((uint32_t)0x00000005U);
 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->OPFCCR = PixelFormatDst;



 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->NLR = (unsigned long)(xSize << 16) | ySize;
...
static void _DMA_LoadLUT(LCD_COLOR * pColor, unsigned long NumItems)
{
 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->FGCMAR = (unsigned long)pColor;



 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->FGPFCCR = ((uint32_t)0x00000001U)

     | ((NumItems - 1) & 0xFF) << 8;
 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->FGPFCCR |= (1 << 5);



}
# 805 "../Src/LCDConf.c"
static void _InvertAlpha_SwapRB(LCD_COLOR * pColorSrc, LCD_COLOR * pColorDst, unsigned long NumItems)
{
 unsigned long Color;

 do {
  Color = *pColorSrc++;
  *pColorDst++ = ((Color & 0x000000FF) << 16)
      | (Color & 0x0000FF00)
      | ((Color & 0x00FF0000) >> 16)
...
# 827 "../Src/LCDConf.c"
static void _InvertAlpha(LCD_COLOR * pColorSrc, LCD_COLOR * pColorDst, unsigned long NumItems)
{
 unsigned long Color;

 do {
  Color = *pColorSrc++;
  *pColorDst++ = Color ^ 0xFF000000;
 } while (--NumItems);
}
...
static void _DMA_AlphaBlending(LCD_COLOR * pColorFG, LCD_COLOR * pColorBG, LCD_COLOR * pColorDst, unsigned long NumItems)
{
...
static void _DMA_Index2ColorBulk(void * pIndex, LCD_COLOR * pColor, unsigned long NumItems, unsigned char SizeOfIndex, unsigned long PixelFormat)
{
 _DMA_ConvertColor(pIndex, _pBuffer_DMA2D, PixelFormat, ((uint32_t)0x00000000U), NumItems);
...
static void _DMA_Color2IndexBulk(LCD_COLOR * pColor, void * pIndex, unsigned long NumItems, unsigned char SizeOfIndex, unsigned long PixelFormat)
{
 ...
 _DMA_ConvertColor(_pBuffer_DMA2D, pIndex, ((uint32_t)0x00000000U), PixelFormat, NumItems);
}
...
static void _LCD_MixColorsBulk(unsigned long * pFG, unsigned long * pBG, unsigned long * pDst, unsigned OffFG, unsigned OffBG, unsigned OffDest, unsigned xSize, unsigned ySize, unsigned char Intens)
{
 int y;
...
static void _LCD_DisplayOn(void)
{
 ...
 HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1000U)), ((uint16_t)0x0004U), GPIO_PIN_SET);
}
...
static void _LCD_DisplayOff(void)
{
 ...
 HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1000U)), ((uint16_t)0x0004U), GPIO_PIN_RESET);
}
...
static unsigned long _GetBufferSize(int LayerIndex)
{
...
static void _LCD_FillRect(int LayerIndex, int x0, int y0, int x1, int y1, unsigned long PixelIndex)
{
 unsigned long BufferSize, AddrDst;
 int xSize, ySize;

 if (GUI_GetDrawMode() == (1<<0))
 {
  LCD_SetDevFunc(LayerIndex, 0x19, 0);
  LCD_FillRect(x0, y0, x1, y1);
  LCD_SetDevFunc(LayerIndex, 0x19, (void(*)(void))_LCD_FillRect);
 }
 else
 {
  xSize = x1 - x0 + 1;
...
# 1016 "../Src/LCDConf.c"
static void _LCD_DrawBitmap32bpp(int LayerIndex, int x, int y, unsigned char const * p, int xSize, int ySize, int BytesPerLine)
{
 unsigned long BufferSize, AddrDst;
...
static void _LCD_DrawBitmap16bpp(int LayerIndex, int x, int y, unsigned short const * p, int xSize, int ySize, int BytesPerLine)
{
 unsigned long BufferSize, AddrDst;
 int OffLineSrc, OffLineDst;
...
static void _LCD_DrawBitmap8bpp(int LayerIndex, int x, int y, unsigned char const * p, int xSize, int ySize, int BytesPerLine)
{
 unsigned long BufferSize, AddrDst;
 int OffLineSrc, OffLineDst;
 unsigned long PixelFormat;
...
# 1070 "../Src/LCDConf.c"
static unsigned long * _LCD_GetpPalConvTable(const LCD_LOGPALETTE * pLogPal, const GUI_BITMAP * pBitmap, int LayerIndex)
{
 void (* pFunc)(void);
 int DoDefault = 0;
 ...
 {
  pFunc = LCD_GetDevFunc(LayerIndex, 0x25);
 ...
 _InvertAlpha_SwapRB((unsigned long *)pLogPal->pPalEntries,
         _pBuffer_DMA2D,
          pLogPal->NumEntries);
...
static void _LCD_SetLUTEntry(int LayerIndex, LCD_COLOR Color, unsigned char Pos)
{
...
{
 if (OnOff) ((((LTDC_Layer_TypeDef *)((uint32_t)(((uint32_t)(((&hltdc))->Instance)) + 0x84 + (0x80*((LayerIndex)))))))->CR |= (uint32_t)(0x1U << (0U)));
 else ((((LTDC_Layer_TypeDef *)((uint32_t)(((uint32_t)(((&hltdc))->Instance)) + 0x84 + (0x80*((LayerIndex)))))))->CR &= ~(uint32_t)(0x1U << (0U)));
...
static void _LCD_InitLayer(int LayerIndex)
{
 ...
 if (LayerIndex < 2)
 {
  ...
  LayerCfg.BlendingFactor1 = ((uint32_t)0x00000600U);
  LayerCfg.BlendingFactor2 = ((uint32_t)0x00000007U);
 ...
 for (i = 0; i < 2; i++)
 {
  if (_aPendingBuffer[i] >= 0)
  {
   Addr = _aAddr[i] + _axSize[i] * _aySize[i] *
       _aPendingBuffer[i] * _aBytesPerPixels[i];
...
void HAL_LTDC_MspInit(LTDC_HandleTypeDef* hltdc)
{
 ...
 do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB2ENR) |= ((0x1U << (26U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB2ENR) & ((0x1U << (26U)))); ((void)(tmpreg)); } while(0);
 do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) |= ((0x1U << (23U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) & ((0x1U << (23U)))); ((void)(tmpreg)); } while(0);
 ...
 do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) |= ((0x1U << (5U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) & ((0x1U << (5U)))); ((void)(tmpreg)); } while(0);
...
# 1299 "../Src/LCDConf.c"
 ...
 GPIO_InitStruct.Alternate = ((uint8_t)0x0EU);
 HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1400U)), &GPIO_InitStruct);

 GPIO_InitStruct.Pin = ((uint16_t)0x0001U)|((uint16_t)0x0040U)|((uint16_t)0x0080U);
 GPIO_InitStruct.Mode = ((uint32_t)0x00000002U);
 GPIO_InitStruct.Pull = ((uint32_t)0x00000000U);
 GPIO_InitStruct.Speed = ((uint32_t)0x00000003U);
 GPIO_InitStruct.Alternate = ((uint8_t)0x0EU);
 ...
 GPIO_InitStruct.Pin = ((uint16_t)0x0008U)|((uint16_t)0x0010U)|((uint16_t)0x0020U)|((uint16_t)0x0040U);
 GPIO_InitStruct.Mode = ((uint32_t)0x00000002U);
 GPIO_InitStruct.Pull = ((uint32_t)0x00000000U);
 GPIO_InitStruct.Speed = ((uint32_t)0x00000003U);
 GPIO_InitStruct.Alternate = ((uint8_t)0x0EU);
 ...
 GPIO_InitStruct.Pull = ((uint32_t)0x00000000U);
 GPIO_InitStruct.Speed = ((uint32_t)0x00000003U);
 GPIO_InitStruct.Alternate = ((uint8_t)0x09U);
 HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U)), &GPIO_InitStruct);

 GPIO_InitStruct.Pin = ((uint16_t)0x0400U)|((uint16_t)0x0800U)|((uint16_t)0x0100U)|((uint16_t)0x0200U);
 GPIO_InitStruct.Mode = ((uint32_t)0x00000002U);
 GPIO_InitStruct.Pull = ((uint32_t)0x00000000U);
 GPIO_InitStruct.Speed = ((uint32_t)0x00000003U);
 GPIO_InitStruct.Alternate = ((uint8_t)0x0EU);
 ...
 GPIO_InitStruct.Pin = ((uint16_t)0x0040U)|((uint16_t)0x0080U)|((uint16_t)0x0800U);
 GPIO_InitStruct.Mode = ((uint32_t)0x00000002U);
 GPIO_InitStruct.Pull = ((uint32_t)0x00000000U);
 GPIO_InitStruct.Speed = ((uint32_t)0x00000003U);
 GPIO_InitStruct.Alternate = ((uint8_t)0x0EU);
 ...
 GPIO_InitStruct.Pin = ((uint16_t)0x0400U)|((uint16_t)0x1000U);
 GPIO_InitStruct.Mode = ((uint32_t)0x00000002U);
 GPIO_InitStruct.Pull = ((uint32_t)0x00000000U);
 GPIO_InitStruct.Speed = ((uint32_t)0x00000003U);
 GPIO_InitStruct.Alternate = ((uint8_t)0x09U);
...
void LCD_X_Config(void)
{
 ...
 hltdc.Instance = ((LTDC_TypeDef *)((0x40000000U + 0x00010000U) + 0x6800U));
 hltdc.Init.HSPolarity = ((uint32_t)0x00000000U);
 hltdc.Init.VSPolarity = ((uint32_t)0x00000000U);
 hltdc.Init.DEPolarity = ((uint32_t)0x00000000U);
 hltdc.Init.PCPolarity = ((uint32_t)0x00000000U);
 hltdc.Init.Backcolor.Red = (0x00800000 >> 0) & 0xFF;
 hltdc.Init.Backcolor.Green = (0x00800000 >> 8) & 0xFF;
 hltdc.Init.Backcolor.Blue = (0x00800000 >> 16) & 0xFF;
 hltdc.Init.HorizontalSync = 1;
 hltdc.Init.VerticalSync = 9;
 hltdc.Init.AccumulatedHBP = 43;
 hltdc.Init.AccumulatedVBP = 21;
 hltdc.Init.AccumulatedActiveW = 43 + 480;
 hltdc.Init.AccumulatedActiveH = 21 + 272;
 hltdc.Init.TotalWidth = 43 + 480 + 8;
 hltdc.Init.TotalHeigh = 21 + 272 + 4;
...
# 1636 "../Src/LCDConf.c"
 ...
 if (LCD_GetSwapXYEx(0))
 {
  ...
  LCD_SetVSizeEx(0, 272 * 1, 480);
 }
 else
 {
  LCD_SetSizeEx (0, 480, 272);
  LCD_SetVSizeEx(0, 480, 272 * 1);
 }



 GUI_DEVICE_CreateAndLink(&GUIDRV_Lin_32_API, &LCD_API_ColorConv_M8888I, 0, 1);

 if (LCD_GetSwapXYEx(1))
 {
  LCD_SetSizeEx (1, 272, 480);
  LCD_SetVSizeEx(1, 272 * 1, 480);
 }
 else
 {
  LCD_SetSizeEx (1, 480, 272);
  LCD_SetVSizeEx(1, 480, 272 * 1);
 }
 ...
 LCD_SetDevFunc(i, 0x21, (void(*)(void))_LCD_CopyBuffer);
 LCD_SetDevFunc(i, 0x23, (void(*)(void))_LCD_CopyRect);
 LCD_SetDevFunc(i, 0x19, (void(*)(void))_LCD_FillRect);
 LCD_SetDevFunc(i, 0x28, (void(*)(void))_LCD_DrawBitmap32bpp);
 LCD_SetDevFunc(i, 0x24, (void(*)(void))_LCD_DrawBitmap16bpp);
 LCD_SetDevFunc(i, 0x25, (void(*)(void))_LCD_DrawBitmap8bpp);
