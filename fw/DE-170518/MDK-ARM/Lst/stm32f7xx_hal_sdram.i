...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_sdram.c" 2
...
# 93 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_sdram.c" 2
...
HAL_StatusTypeDef HAL_SDRAM_DeInit(SDRAM_HandleTypeDef *hsdram)
{
  ...
  do{ (hsdram)->Lock = HAL_UNLOCKED; }while (0);
...
__attribute__((weak)) void HAL_SDRAM_MspInit(SDRAM_HandleTypeDef *hsdram)
{
...
__attribute__((weak)) void HAL_SDRAM_MspDeInit(SDRAM_HandleTypeDef *hsdram)
{
...
__attribute__((weak)) void HAL_SDRAM_RefreshErrorCallback(SDRAM_HandleTypeDef *hsdram)
{
...
__attribute__((weak)) void HAL_SDRAM_DMA_XferCpltCallback(DMA_HandleTypeDef *hdma)
{
...
__attribute__((weak)) void HAL_SDRAM_DMA_XferErrorCallback(DMA_HandleTypeDef *hdma)
{
...
# 315 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_sdram.c"
HAL_StatusTypeDef HAL_SDRAM_Read_8b(SDRAM_HandleTypeDef *hsdram, uint32_t *pAddress, uint8_t *pDstBuffer, uint32_t BufferSize)
{
  volatile uint8_t *pSdramAddress = (uint8_t *)pAddress;


  do{ if((hsdram)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (hsdram)->Lock = HAL_LOCKED; } }while (0);
...
# 400 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_sdram.c"
HAL_StatusTypeDef HAL_SDRAM_Read_16b(SDRAM_HandleTypeDef *hsdram, uint32_t *pAddress, uint16_t *pDstBuffer, uint32_t BufferSize)
{
...
# 483 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_sdram.c"
HAL_StatusTypeDef HAL_SDRAM_Read_32b(SDRAM_HandleTypeDef *hsdram, uint32_t *pAddress, uint32_t *pDstBuffer, uint32_t BufferSize)
{
...
# 566 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_sdram.c"
HAL_StatusTypeDef HAL_SDRAM_Read_DMA(SDRAM_HandleTypeDef *hsdram, uint32_t *pAddress, uint32_t *pDstBuffer, uint32_t BufferSize)
{
  uint32_t tmp = 0;
...
# 664 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_sdram.c"
HAL_StatusTypeDef HAL_SDRAM_WriteProtection_Enable(SDRAM_HandleTypeDef *hsdram)
{
...
# 752 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_sdram.c"
HAL_StatusTypeDef HAL_SDRAM_ProgramRefreshRate(SDRAM_HandleTypeDef *hsdram, uint32_t RefreshRate)
{
...
# 779 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_sdram.c"
HAL_StatusTypeDef HAL_SDRAM_SetAutoRefreshNumber(SDRAM_HandleTypeDef *hsdram, uint32_t AutoRefreshNumber)
{
...
# 836 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_sdram.c"
HAL_SDRAM_StateTypeDef HAL_SDRAM_GetState(SDRAM_HandleTypeDef *hsdram)
{
  return hsdram->State;
}
