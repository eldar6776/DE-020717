# 1 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 370 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c" 2
# 111 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
...
# 112 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c" 2
# 130 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
static void LTDC_SetConfig(LTDC_HandleTypeDef *hltdc, LTDC_LayerCfgTypeDef *pLayerCfg, uint32_t LayerIdx);
# 159 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_StatusTypeDef HAL_LTDC_Init(LTDC_HandleTypeDef *hltdc)
{
...
# 252 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_StatusTypeDef HAL_LTDC_DeInit(LTDC_HandleTypeDef *hltdc)
{
  ...
  do{ (hltdc)->Lock = HAL_UNLOCKED; }while (0);
...
__attribute__((weak)) void HAL_LTDC_MspInit(LTDC_HandleTypeDef* hltdc)
{
...
__attribute__((weak)) void HAL_LTDC_MspDeInit(LTDC_HandleTypeDef* hltdc)
{
...
# 324 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
void HAL_LTDC_IRQHandler(LTDC_HandleTypeDef *hltdc)
{
...
__attribute__((weak)) void HAL_LTDC_ErrorCallback(LTDC_HandleTypeDef *hltdc)
{
...
__attribute__((weak)) void HAL_LTDC_LineEventCallback(LTDC_HandleTypeDef *hltdc)
{
...
__attribute__((weak)) void HAL_LTDC_ReloadEventCallback(LTDC_HandleTypeDef *hltdc)
{
...
# 506 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_StatusTypeDef HAL_LTDC_ConfigLayer(LTDC_HandleTypeDef *hltdc, LTDC_LayerCfgTypeDef *pLayerCfg, uint32_t LayerIdx)
{

  do{ if((hltdc)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (hltdc)->Lock = HAL_LOCKED; } }while (0);
...
# 555 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_StatusTypeDef HAL_LTDC_ConfigColorKeying(LTDC_HandleTypeDef *hltdc, uint32_t RGBValue, uint32_t LayerIdx)
{
...
# 593 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_StatusTypeDef HAL_LTDC_ConfigCLUT(LTDC_HandleTypeDef *hltdc, uint32_t *pCLUT, uint32_t CLUTSize, uint32_t LayerIdx)
{
  uint32_t tmp = 0;
  uint32_t counter = 0;
...
# 643 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_StatusTypeDef HAL_LTDC_EnableColorKeying(LTDC_HandleTypeDef *hltdc, uint32_t LayerIdx)
{
...
# 678 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_StatusTypeDef HAL_LTDC_DisableColorKeying(LTDC_HandleTypeDef *hltdc, uint32_t LayerIdx)
{
...
# 713 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_StatusTypeDef HAL_LTDC_EnableCLUT(LTDC_HandleTypeDef *hltdc, uint32_t LayerIdx)
{
...
# 749 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_StatusTypeDef HAL_LTDC_DisableCLUT(LTDC_HandleTypeDef *hltdc, uint32_t LayerIdx)
{
...
# 783 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_StatusTypeDef HAL_LTDC_EnableDither(LTDC_HandleTypeDef *hltdc)
{
...
# 810 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_StatusTypeDef HAL_LTDC_DisableDither(LTDC_HandleTypeDef *hltdc)
{
...
# 841 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_StatusTypeDef HAL_LTDC_SetWindowSize(LTDC_HandleTypeDef *hltdc, uint32_t XSize, uint32_t YSize, uint32_t LayerIdx)
{
...
# 903 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_StatusTypeDef HAL_LTDC_SetWindowPosition(LTDC_HandleTypeDef *hltdc, uint32_t X0, uint32_t Y0, uint32_t LayerIdx)
{
  LTDC_LayerCfgTypeDef *pLayerCfg;
...
# 956 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_StatusTypeDef HAL_LTDC_SetPixelFormat(LTDC_HandleTypeDef *hltdc, uint32_t Pixelformat, uint32_t LayerIdx)
{
  LTDC_LayerCfgTypeDef *pLayerCfg;
...
# 1001 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_StatusTypeDef HAL_LTDC_SetAlpha(LTDC_HandleTypeDef *hltdc, uint32_t Alpha, uint32_t LayerIdx)
{
  LTDC_LayerCfgTypeDef *pLayerCfg;
...
# 1045 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_StatusTypeDef HAL_LTDC_SetAddress(LTDC_HandleTypeDef *hltdc, uint32_t Address, uint32_t LayerIdx)
{
  LTDC_LayerCfgTypeDef *pLayerCfg;
...
# 1092 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_StatusTypeDef HAL_LTDC_SetPitch(LTDC_HandleTypeDef *hltdc, uint32_t LinePitchInPixels, uint32_t LayerIdx)
{
  uint32_t tmp = 0;
...
# 1160 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_StatusTypeDef HAL_LTDC_ProgramLineEvent(LTDC_HandleTypeDef *hltdc, uint32_t Line)
{
...
# 1195 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_StatusTypeDef HAL_LTDC_Reload(LTDC_HandleTypeDef *hltdc, uint32_t ReloadType)
{
  ((void)0U);
...
# 1233 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_StatusTypeDef HAL_LTDC_ConfigLayer_NoReload(LTDC_HandleTypeDef *hltdc, LTDC_LayerCfgTypeDef *pLayerCfg, uint32_t LayerIdx)
{
...
# 1283 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_StatusTypeDef HAL_LTDC_SetWindowSize_NoReload(LTDC_HandleTypeDef *hltdc, uint32_t XSize, uint32_t YSize, uint32_t LayerIdx)
{
  LTDC_LayerCfgTypeDef *pLayerCfg;
...
# 1345 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_StatusTypeDef HAL_LTDC_SetWindowPosition_NoReload(LTDC_HandleTypeDef *hltdc, uint32_t X0, uint32_t Y0, uint32_t LayerIdx)
{
  LTDC_LayerCfgTypeDef *pLayerCfg;
...
# 1398 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_StatusTypeDef HAL_LTDC_SetPixelFormat_NoReload(LTDC_HandleTypeDef *hltdc, uint32_t Pixelformat, uint32_t LayerIdx)
{
  LTDC_LayerCfgTypeDef *pLayerCfg;
...
# 1443 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_StatusTypeDef HAL_LTDC_SetAlpha_NoReload(LTDC_HandleTypeDef *hltdc, uint32_t Alpha, uint32_t LayerIdx)
{
  LTDC_LayerCfgTypeDef *pLayerCfg;
...
# 1488 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_StatusTypeDef HAL_LTDC_SetAddress_NoReload(LTDC_HandleTypeDef *hltdc, uint32_t Address, uint32_t LayerIdx)
{
  LTDC_LayerCfgTypeDef *pLayerCfg;
...
# 1535 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_StatusTypeDef HAL_LTDC_SetPitch_NoReload(LTDC_HandleTypeDef *hltdc, uint32_t LinePitchInPixels, uint32_t LayerIdx)
{
  uint32_t tmp = 0;
  uint32_t pitchUpdate = 0;
...
# 1604 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_StatusTypeDef HAL_LTDC_ConfigColorKeying_NoReload(LTDC_HandleTypeDef *hltdc, uint32_t RGBValue, uint32_t LayerIdx)
{
...
# 1640 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_StatusTypeDef HAL_LTDC_EnableColorKeying_NoReload(LTDC_HandleTypeDef *hltdc, uint32_t LayerIdx)
{
...
# 1675 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_StatusTypeDef HAL_LTDC_DisableColorKeying_NoReload(LTDC_HandleTypeDef *hltdc, uint32_t LayerIdx)
{
...
# 1710 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_StatusTypeDef HAL_LTDC_EnableCLUT_NoReload(LTDC_HandleTypeDef *hltdc, uint32_t LayerIdx)
{
...
# 1746 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_StatusTypeDef HAL_LTDC_DisableCLUT_NoReload(LTDC_HandleTypeDef *hltdc, uint32_t LayerIdx)
{
...
# 1798 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
HAL_LTDC_StateTypeDef HAL_LTDC_GetState(LTDC_HandleTypeDef *hltdc)
{
  return hltdc->State;
}
...
# 1827 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_ltdc.c"
static void LTDC_SetConfig(LTDC_HandleTypeDef *hltdc, LTDC_LayerCfgTypeDef *pLayerCfg, uint32_t LayerIdx)
{
  uint32_t tmp = 0;
  uint32_t tmp1 = 0;
