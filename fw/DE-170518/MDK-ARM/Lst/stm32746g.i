# 1 "../Drivers/BSP/STM32F746/stm32746g.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 370 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/BSP/STM32F746/stm32746g.c" 2
# 46 "../Drivers/BSP/STM32F746/stm32746g.c"
# 1 "../Drivers/BSP/STM32F746/stm32746g.h" 1
# 46 "../Drivers/BSP/STM32F746/stm32746g.h"
...
# 47 "../Drivers/BSP/STM32F746/stm32746g.h" 2
...
# 47 "../Drivers/BSP/STM32F746/stm32746g.c" 2
# 96 "../Drivers/BSP/STM32F746/stm32746g.c"
const uint32_t GPIO_PIN[((uint8_t)1)] = {((uint16_t)0x0080U)};

GPIO_TypeDef* BUTTON_PORT[((uint8_t)3)] = {((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x2000U)),
                                      ((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x2000U)),
                                      ((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x2000U))};

const uint16_t BUTTON_PIN[((uint8_t)3)] = {((uint16_t)0x0800U),
                                      ((uint16_t)0x0800U),
                                      ((uint16_t)0x0800U)};

const uint16_t BUTTON_IRQn[((uint8_t)3)] = {EXTI15_10_IRQn,
                                       EXTI15_10_IRQn,
                                       EXTI15_10_IRQn};

USART_TypeDef* COM_USART[((uint8_t)1)] = {((USART_TypeDef *) ((0x40000000U + 0x00010000U) + 0x1000U))};

GPIO_TypeDef* COM_TX_PORT[((uint8_t)1)] = {((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U))};

GPIO_TypeDef* COM_RX_PORT[((uint8_t)1)] = {((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U))};

const uint16_t COM_TX_PIN[((uint8_t)1)] = {((uint16_t)0x0200U)};

const uint16_t COM_RX_PIN[((uint8_t)1)] = {((uint16_t)0x0080U)};

const uint16_t COM_TX_AF[((uint8_t)1)] = {((uint8_t)0x07U)};

const uint16_t COM_RX_AF[((uint8_t)1)] = {((uint8_t)0x07U)};

static I2C_HandleTypeDef hI2cAudioHandler = {0};
static I2C_HandleTypeDef hI2cExtHandler = {0};
# 134 "../Drivers/BSP/STM32F746/stm32746g.c"
...
# 178 "../Drivers/BSP/STM32F746/stm32746g.c"
uint32_t BSP_GetVersion(void)
{
  return (((0x02) << 24) |((0x00) << 16) |((0x02) << 8 ) |((0x00)));
}
# 190 "../Drivers/BSP/STM32F746/stm32746g.c"
void LED_Init(Led_TypeDef Led)
{
  ...
  if (Led == LED1)
  {
    gpio_led = ((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0C00U));
    ...
    gpio_init_structure.Mode = ((uint32_t)0x00000001U);
    gpio_init_structure.Pull = ((uint32_t)0x00000001U);
    gpio_init_structure.Speed = ((uint32_t)0x00000003U);
...
# 222 "../Drivers/BSP/STM32F746/stm32746g.c"
void BSP_LED_DeInit(Led_TypeDef Led)
{
  GPIO_InitTypeDef gpio_init_structure;
  GPIO_TypeDef* gpio_led;
...
# 245 "../Drivers/BSP/STM32F746/stm32746g.c"
void BSP_LED_On(Led_TypeDef Led)
{
  GPIO_TypeDef* gpio_led;
...
# 263 "../Drivers/BSP/STM32F746/stm32746g.c"
void BSP_LED_Off(Led_TypeDef Led)
{
  GPIO_TypeDef* gpio_led;
...
# 281 "../Drivers/BSP/STM32F746/stm32746g.c"
void BSP_LED_Toggle(Led_TypeDef Led)
{
  GPIO_TypeDef* gpio_led;
...
# 309 "../Drivers/BSP/STM32F746/stm32746g.c"
void BSP_PB_Init(Button_TypeDef Button, ButtonMode_TypeDef ButtonMode)
{
  GPIO_InitTypeDef gpio_init_structure;


  do { if((Button) == 0) do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) |= ((0x1U << (8U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) & ((0x1U << (8U)))); ((void)(tmpreg)); } while(0); else if((Button) == 1) do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) |= ((0x1U << (8U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) & ((0x1U << (8U)))); ((void)(tmpreg)); } while(0); else do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) |= ((0x1U << (8U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) & ((0x1U << (8U)))); ((void)(tmpreg)); } while(0); } while(0);

  if(ButtonMode == BUTTON_MODE_GPIO)
  {

    gpio_init_structure.Pin = BUTTON_PIN[Button];
    gpio_init_structure.Mode = ((uint32_t)0x00000000U);
    gpio_init_structure.Pull = ((uint32_t)0x00000000U);
  ...
  if(ButtonMode == BUTTON_MODE_EXTI)
  {
    ...
    {
      gpio_init_structure.Mode = ((uint32_t)0x10210000U);
    }
    else
    {
      gpio_init_structure.Mode = ((uint32_t)0x10110000U);
    }
...
# 363 "../Drivers/BSP/STM32F746/stm32746g.c"
void BSP_PB_DeInit(Button_TypeDef Button)
{
    GPIO_InitTypeDef gpio_init_structure;
...
# 385 "../Drivers/BSP/STM32F746/stm32746g.c"
uint32_t BSP_PB_GetState(Button_TypeDef Button)
{
  return HAL_GPIO_ReadPin(BUTTON_PORT[Button], BUTTON_PIN[Button]);
}
# 400 "../Drivers/BSP/STM32F746/stm32746g.c"
void BSP_COM_Init(COM_TypeDef COM, UART_HandleTypeDef *huart)
{
  GPIO_InitTypeDef gpio_init_structure;


  do { if((COM) == COM1) do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) |= ((0x1U << (0U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) & ((0x1U << (0U)))); ((void)(tmpreg)); } while(0); } while(0);
  do { if((COM) == COM1) do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) |= ((0x1U << (1U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) & ((0x1U << (1U)))); ((void)(tmpreg)); } while(0); } while(0);


  do { if((COM) == COM1) do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB2ENR) |= ((0x1U << (4U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB2ENR) & ((0x1U << (4U)))); ((void)(tmpreg)); } while(0); } while(0);


  gpio_init_structure.Pin = COM_TX_PIN[COM];
  gpio_init_structure.Mode = ((uint32_t)0x00000002U);
  gpio_init_structure.Speed = ((uint32_t)0x00000002U);
  gpio_init_structure.Pull = ((uint32_t)0x00000001U);
...
# 440 "../Drivers/BSP/STM32F746/stm32746g.c"
void BSP_COM_DeInit(COM_TypeDef COM, UART_HandleTypeDef *huart)
{
  ...
  (((COM) == 0) ? (((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB2ENR &= ~((0x1U << (4U)))) : 0);
...
# 466 "../Drivers/BSP/STM32F746/stm32746g.c"
static void I2Cx_MspInit(I2C_HandleTypeDef *i2c_handler)
{
 ...
 do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1ENR) |= ((0x1U << (23U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1ENR) & ((0x1U << (23U)))); ((void)(tmpreg)); } while(0);


 (((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1RSTR |= ((0x1U << (23U))));
...
static void I2Cx_Init(I2C_HandleTypeDef *i2c_handler)
{
 ...
 {
  i2c_handler->Instance = ((I2C_TypeDef *) (0x40000000U + 0x5C00U));
  i2c_handler->Init.Timing = ((uint32_t)0x40912732);
  i2c_handler->Init.OwnAddress1 = 0;
  i2c_handler->Init.AddressingMode = (0x00000001U);
  i2c_handler->Init.DualAddressMode = (0x00000000U);
  i2c_handler->Init.OwnAddress2 = 0;
  i2c_handler->Init.GeneralCallMode = (0x00000000U);
  i2c_handler->Init.NoStretchMode = (0x00000000U);

  I2Cx_MspInit(i2c_handler);
  HAL_I2C_Init(i2c_handler);
 }
}
# 546 "../Drivers/BSP/STM32F746/stm32746g.c"
...
# 576 "../Drivers/BSP/STM32F746/stm32746g.c"
...
# 604 "../Drivers/BSP/STM32F746/stm32746g.c"
static HAL_StatusTypeDef I2Cx_IsDeviceReady(I2C_HandleTypeDef *i2c_handler, uint16_t DevAddress, uint32_t Trials)
{
...
# 634 "../Drivers/BSP/STM32F746/stm32746g.c"
void AUDIO_IO_Init(void)
{
...
# 654 "../Drivers/BSP/STM32F746/stm32746g.c"
void AUDIO_IO_Write(uint8_t Addr, uint16_t Reg, uint16_t Value)
{
  uint16_t tmp = Value;
  ...
  I2Cx_WriteMultiple(&hI2cAudioHandler, Addr, Reg, (0x00000002U),(uint8_t*)&Value, 2);
}
...
uint16_t AUDIO_IO_Read(uint8_t Addr, uint16_t Reg)
{
  ...
  I2Cx_ReadMultiple(&hI2cAudioHandler, Addr, Reg, (0x00000002U), (uint8_t*)&read_value, 2);
...
# 714 "../Drivers/BSP/STM32F746/stm32746g.c"
void CAMERA_IO_Write(uint8_t Addr, uint8_t Reg, uint8_t Value)
{
  I2Cx_WriteMultiple(&hI2cExtHandler, Addr, (uint16_t)Reg, (0x00000001U),(uint8_t*)&Value, 1);
}
...
uint8_t CAMERA_IO_Read(uint8_t Addr, uint8_t Reg)
{
  ...
  I2Cx_ReadMultiple(&hI2cExtHandler, Addr, Reg, (0x00000001U), (uint8_t*)&read_value, 1);
...
# 763 "../Drivers/BSP/STM32F746/stm32746g.c"
HAL_StatusTypeDef EEPROM_IO_WriteData(uint16_t DevAddress, uint16_t MemAddress, uint8_t* pBuffer, uint32_t BufferSize)
{
  return (I2Cx_WriteMultiple(&hI2cExtHandler, DevAddress, MemAddress, (0x00000002U), pBuffer, BufferSize));
}
# 776 "../Drivers/BSP/STM32F746/stm32746g.c"
HAL_StatusTypeDef EEPROM_IO_ReadData(uint16_t DevAddress, uint16_t MemAddress, uint8_t* pBuffer, uint32_t BufferSize)
{
  return (I2Cx_ReadMultiple(&hI2cExtHandler, DevAddress, MemAddress, (0x00000002U), pBuffer, BufferSize));
}
# 788 "../Drivers/BSP/STM32F746/stm32746g.c"
HAL_StatusTypeDef EEPROM_IO_IsDeviceReady(uint16_t DevAddress, uint32_t Trials)
{
...
# 811 "../Drivers/BSP/STM32F746/stm32746g.c"
void TS_IO_Write(uint8_t Addr, uint8_t Reg, uint8_t Value)
{
  I2Cx_WriteMultiple(&hI2cAudioHandler, Addr, (uint16_t)Reg, (0x00000001U),(uint8_t*)&Value, 1);
}
...
uint8_t TS_IO_Read(uint8_t Addr, uint8_t Reg)
{
  ...
  I2Cx_ReadMultiple(&hI2cAudioHandler, Addr, Reg, (0x00000001U), (uint8_t*)&read_value, 1);
