...
# 38 "../Src/stm32f7xx_it.c" 2
# 1 "../Inc\\stm32f7xx_it.h" 1
# 53 "../Inc\\stm32f7xx_it.h"
...
void DMA2D_IRQHandler(void)
{
 ...
 ((DMA2D_TypeDef *)((0x40000000U + 0x00020000U) + 0xB000U))->IFCR = (unsigned long)(0x1U << (1U));
}
...
void EXTI3_IRQHandler(void)
{
 HAL_GPIO_EXTI_IRQHandler(((uint16_t)0x0008U));
}


void EXTI15_10_IRQHandler(void)
{
 HAL_GPIO_EXTI_IRQHandler(((uint16_t)0x2000U));
}
