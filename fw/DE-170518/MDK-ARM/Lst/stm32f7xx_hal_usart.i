# 1 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_usart.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 370 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_usart.c" 2
# 81 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_usart.c"
...
# 82 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_usart.c" 2
# 115 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_usart.c"
...
# 189 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_usart.c"
HAL_StatusTypeDef HAL_USART_Init(USART_HandleTypeDef *husart)
{
  ...
  ((husart->Instance->CR2) &= ~((0x1U << (14U))));
  ((husart->Instance->CR3) &= ~(((0x1U << (5U)) | (0x1U << (3U)) | (0x1U << (1U)))));
...
# 365 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_usart.c"
HAL_StatusTypeDef HAL_USART_Transmit(USART_HandleTypeDef *husart, uint8_t *pTxData, uint16_t Size, uint32_t Timeout)
{
  uint16_t* tmp;
  ...
  if(husart->State == HAL_USART_STATE_READY)
  {
    ...
    while(husart->TxXferCount > 0U)
    {
      ...
      if((husart->Init.WordLength == ((uint32_t)(0x00001U << (12U)))) && (husart->Init.Parity == ((uint32_t)0x0000U)))
      {
...
# 436 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_usart.c"
HAL_StatusTypeDef HAL_USART_Receive(USART_HandleTypeDef *husart, uint8_t *pRxData, uint16_t Size, uint32_t Timeout)
{
  uint16_t* tmp;
  uint16_t uhMask;
  ...
  if(husart->State == HAL_USART_STATE_READY)
  {
    ...
    do { if ((husart)->Init.WordLength == ((uint32_t)(0x00001U << (12U)))) { if ((husart)->Init.Parity == ((uint32_t)0x0000U)) { (husart)->Mask = 0x01FF ; } else { (husart)->Mask = 0x00FF ; } } else if ((husart)->Init.WordLength == ((uint32_t)0x00000000U)) { if ((husart)->Init.Parity == ((uint32_t)0x0000U)) { (husart)->Mask = 0x00FF ; } else { (husart)->Mask = 0x007F ; } } else if ((husart)->Init.WordLength == ((uint32_t)0x10000000U)) { if ((husart)->Init.Parity == ((uint32_t)0x0000U)) { (husart)->Mask = 0x007F ; } else { (husart)->Mask = 0x003F ; } } } while(0);
    uhMask = husart->Mask;
    ...
    while(husart->RxXferCount > 0U)
    {
      ...
      husart->Instance->TDR = (((uint16_t) 0xFFFFU) & (uint16_t)0x0FFU);
...
# 519 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_usart.c"
HAL_StatusTypeDef HAL_USART_TransmitReceive(USART_HandleTypeDef *husart, uint8_t *pTxData, uint8_t *pRxData, uint16_t Size, uint32_t Timeout)
{
  uint16_t* tmp;
  uint16_t uhMask;
...
# 609 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_usart.c"
HAL_StatusTypeDef HAL_USART_Transmit_IT(USART_HandleTypeDef *husart, uint8_t *pTxData, uint16_t Size)
{
  if(husart->State == HAL_USART_STATE_READY)
  {
    ...
    husart->ErrorCode = ((uint32_t)0x00000000U);
    husart->State = HAL_USART_STATE_BUSY_TX;
# 635 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_usart.c"
    do{ (husart)->Lock = HAL_UNLOCKED; }while (0);


    ((husart->Instance->CR3) |= ((0x1U << (0U))));
...
# 656 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_usart.c"
HAL_StatusTypeDef HAL_USART_Receive_IT(USART_HandleTypeDef *husart, uint8_t *pRxData, uint16_t Size)
{
  if(husart->State == HAL_USART_STATE_READY)
  {
    ...
    ((husart->Instance->CR1) |= ((0x1U << (8U)) | (0x1U << (5U))));
    ...
    if(husart->Init.WordLength == ((uint32_t)(0x00001U << (12U))))
    {
      husart->Instance->TDR = (((uint16_t) 0xFFFFU) & (uint16_t)0x01FFU);
    }
    else
    {
      husart->Instance->TDR = (((uint16_t) 0xFFFFU) & (uint16_t)0x00FFU);
    }
...
# 712 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_usart.c"
HAL_StatusTypeDef HAL_USART_TransmitReceive_IT(USART_HandleTypeDef *husart, uint8_t *pTxData, uint8_t *pRxData, uint16_t Size)
{
  ...
  if(husart->State == HAL_USART_STATE_READY)
  {
    ...
    ((husart->Instance->CR1) |= ((0x1U << (5U))));


    ((husart->Instance->CR1) |= ((0x1U << (8U))));
    ...
    (((((uint8_t)(((uint16_t)0x0727U))) >> 5U) == 1)? ((husart)->Instance->CR1 |= (1U << ((((uint16_t)0x0727U)) & ((uint16_t)0x001FU)))): ((((uint8_t)(((uint16_t)0x0727U))) >> 5U) == 2)? ((husart)->Instance->CR2 |= (1U << ((((uint16_t)0x0727U)) & ((uint16_t)0x001FU)))): ((husart)->Instance->CR3 |= (1U << ((((uint16_t)0x0727U)) & ((uint16_t)0x001FU)))));
...
# 767 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_usart.c"
HAL_StatusTypeDef HAL_USART_Transmit_DMA(USART_HandleTypeDef *husart, uint8_t *pTxData, uint16_t Size)
{
  uint32_t *tmp;
  ...
  if(husart->State == HAL_USART_STATE_READY)
  {
    ...
    ((husart->Instance->CR3) |= ((0x1U << (0U))));
    ((husart->Instance->ISR) |= (((0x1U << (0U)) | (0x1U << (1U)) | (0x1U << (2U)) | (0x1U << (3U)))));
    ...
    ((husart)->Instance->ICR = (uint32_t)(((uint32_t)0x00000040U)));
...
# 832 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_usart.c"
HAL_StatusTypeDef HAL_USART_Receive_DMA(USART_HandleTypeDef *husart, uint8_t *pRxData, uint16_t Size)
{
  uint32_t *tmp;
...
# 922 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_usart.c"
HAL_StatusTypeDef HAL_USART_TransmitReceive_DMA(USART_HandleTypeDef *husart, uint8_t *pTxData, uint8_t *pRxData, uint16_t Size)
{
  uint32_t *tmp;
...
HAL_StatusTypeDef HAL_USART_DMAPause(USART_HandleTypeDef *husart)
{
  ...
  else if(husart->State == HAL_USART_STATE_BUSY_RX)
  {
    ...
    ((husart->Instance->CR1) &= ~(((0x1U << (5U)) | (0x1U << (8U)))));
    ((husart->Instance->CR3) &= ~((0x1U << (0U))));
...
HAL_StatusTypeDef HAL_USART_DMAResume(USART_HandleTypeDef *husart)
{
  ...
  else if(husart->State == HAL_USART_STATE_BUSY_RX)
  {
    ...
    ((husart)->Instance->ICR = (uint32_t)((0x1U << (3U))));
...
HAL_StatusTypeDef HAL_USART_DMAStop(USART_HandleTypeDef *husart)
{
# 1098 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_usart.c"
  if ((husart->State == HAL_USART_STATE_BUSY_TX) &&
      ((((husart->Instance->CR3) & ((0x1U << (7U)))) != RESET)))
  {
  ...
  if ((husart->State == HAL_USART_STATE_BUSY_RX) &&
      ((((husart->Instance->CR3) & ((0x1U << (6U)))) != RESET)))
  {
...
void HAL_USART_IRQHandler(USART_HandleTypeDef *husart)
{
         ...
         || ((cr1its & ((0x1U << (5U)) | (0x1U << (8U)))) != RESET)) )
  {
    ...
    {
      ((husart)->Instance->ICR = (uint32_t)((0x1U << (0U))));
    ...
    {
      ((husart)->Instance->ICR = (uint32_t)((0x1U << (1U))));
    ...
    {
      ((husart)->Instance->ICR = (uint32_t)((0x1U << (2U))));
    ...
    if(husart->ErrorCode != ((uint32_t)0x00000000U))
    {
      ...
      if (((husart->ErrorCode & ((uint32_t)0x00000008U)) != RESET) ||
          ((((husart->Instance->CR3) & ((0x1U << (6U)))) != RESET)))
      {
        ...
        if ((((husart->Instance->CR3) & ((0x1U << (6U)))) != RESET))
        {
          ((husart->Instance->CR3) &= ~((0x1U << (6U))));
...
# 1398 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_usart.c"
HAL_USART_StateTypeDef HAL_USART_GetState(USART_HandleTypeDef *husart)
{
  return husart->State;
}
...
# 1427 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_usart.c"
static HAL_StatusTypeDef USART_Transmit_IT(USART_HandleTypeDef *husart)
{
  uint16_t* tmp;
  ...
  if(husart->State == HAL_USART_STATE_BUSY_TX)
  {
    ...
    if(husart->TxXferCount == 0U)
    {
      ...
      (((((uint8_t)(((uint16_t)0x0626U))) >> 5U) == 1)? ((husart)->Instance->CR1 |= (1U << ((((uint16_t)0x0626U)) & ((uint16_t)0x001FU)))): ((((uint8_t)(((uint16_t)0x0626U))) >> 5U) == 2)? ((husart)->Instance->CR2 |= (1U << ((((uint16_t)0x0626U)) & ((uint16_t)0x001FU)))): ((husart)->Instance->CR3 |= (1U << ((((uint16_t)0x0626U)) & ((uint16_t)0x001FU)))));
...
# 1496 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_usart.c"
static HAL_StatusTypeDef USART_Receive_IT(USART_HandleTypeDef *husart)
{
  uint16_t* tmp;
...
# 1549 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_usart.c"
static HAL_StatusTypeDef USART_TransmitReceive_IT(USART_HandleTypeDef *husart)
{
  uint16_t* tmp;
  uint16_t uhMask = husart->Mask;
  ...
  if(husart->State == HAL_USART_STATE_BUSY_TX_RX)
  {
    ...
    {
      if((((husart)->Instance->ISR & (((uint32_t)0x00000080U))) == (((uint32_t)0x00000080U))) != RESET)
      {
        if((husart->Init.WordLength == ((uint32_t)(0x00001U << (12U)))) && (husart->Init.Parity == ((uint32_t)0x0000U)))
        {
          tmp = (uint16_t*) husart->pTxBuffPtr;
    ...
    {
      if((((husart)->Instance->ISR & (((uint32_t)0x00000020U))) == (((uint32_t)0x00000020U))) != RESET)
      {
        if((husart->Init.WordLength == ((uint32_t)(0x00001U << (12U)))) && (husart->Init.Parity == ((uint32_t)0x0000U)))
        {
          tmp = (uint16_t*) husart->pRxBuffPtr;
...
# 1633 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_usart.c"
static HAL_StatusTypeDef USART_WaitOnFlagUntilTimeout(USART_HandleTypeDef *husart, uint32_t Flag, FlagStatus Status, uint32_t Tickstart, uint32_t Timeout)
{
...
static void USART_EndTxTransfer(USART_HandleTypeDef *husart)
{
  ...
  ((husart->Instance->CR1) &= ~(((0x1U << (7U)) | (0x1U << (6U)))));
}
...
static HAL_StatusTypeDef USART_SetConfig(USART_HandleTypeDef *husart)
{
  ...
  ((void)0U);
  ((void)0U);
# 1886 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_usart.c"
  tmpreg = (uint32_t)husart->Init.WordLength | husart->Init.Parity | husart->Init.Mode | (0x1U << (15U));
  (((husart->Instance->CR1)) = ((((((husart->Instance->CR1))) & (~(((uint32_t)((0x10001U << (12U)) | (0x1U << (10U)) | (0x1U << (9U)) | (0x1U << (3U)) | (0x1U << (2U)) | (0x1U << (15U))))))) | (tmpreg))));
  ...
  tmpreg = (uint32_t)(((uint32_t)(0x1U << (11U))));
  tmpreg |= ((uint32_t)husart->Init.CLKPolarity | (uint32_t)husart->Init.CLKPhase);
  tmpreg |= ((uint32_t)husart->Init.CLKLastBit | (uint32_t)husart->Init.StopBits);
  (((husart->Instance->CR2)) = ((((((husart->Instance->CR2))) & (~(((uint32_t)((0x1U << (9U)) | (0x1U << (10U)) | (0x1U << (11U)) | (0x1U << (8U)) | (0x3U << (12U))))))) | (tmpreg))));
  ...
  do { if((husart)->Instance == ((USART_TypeDef *) ((0x40000000U + 0x00010000U) + 0x1000U))) { switch(((uint32_t)(((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->DCKCFGR2) & ((0x3U << (0U))))))) { case ((uint32_t)0x00000000U): (clocksource) = USART_CLOCKSOURCE_PCLK2; break; case (0x2U << (0U)): (clocksource) = USART_CLOCKSOURCE_HSI; break; case (0x1U << (0U)): (clocksource) = USART_CLOCKSOURCE_SYSCLK; break; case (0x3U << (0U)): (clocksource) = USART_CLOCKSOURCE_LSE; break; default: break; } } else if((husart)->Instance == ((USART_TypeDef *) (0x40000000U + 0x4400U))) { switch(((uint32_t)(((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->DCKCFGR2) & ((0x3U << (2U))))))) { case ((uint32_t)0x00000000U): (clocksource) = USART_CLOCKSOURCE_PCLK1; break; case (0x2U << (2U)): (clocksource) = USART_CLOCKSOURCE_HSI; break; case (0x1U << (2U)): (clocksource) = USART_CLOCKSOURCE_SYSCLK; break; case (0x3U << (2U)): (clocksource) = USART_CLOCKSOURCE_LSE; break; default: break; } } else if((husart)->Instance == ((USART_TypeDef *) (0x40000000U + 0x4800U))) { switch(((uint32_t)(((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->DCKCFGR2) & ((0x3U << (4U))))))) { case ((uint32_t)0x00000000U): (clocksource) = USART_CLOCKSOURCE_PCLK1; break; case (0x2U << (4U)): (clocksource) = USART_CLOCKSOURCE_HSI; break; case (0x1U << (4U)): (clocksource) = USART_CLOCKSOURCE_SYSCLK; break; case (0x3U << (4U)): (clocksource) = USART_CLOCKSOURCE_LSE; break; default: break; } } else if((husart)->Instance == ((USART_TypeDef *) ((0x40000000U + 0x00010000U) + 0x1400U))) { switch(((uint32_t)(((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->DCKCFGR2) & ((0x3U << (10U))))))) { case ((uint32_t)0x00000000U): (clocksource) = USART_CLOCKSOURCE_PCLK2; break; case (0x2U << (10U)): (clocksource) = USART_CLOCKSOURCE_HSI; break; case (0x1U << (10U)): (clocksource) = USART_CLOCKSOURCE_SYSCLK; break; case (0x3U << (10U)): (clocksource) = USART_CLOCKSOURCE_LSE; break; default: break; } } } while(0);
  switch (clocksource)
  {
    ...
    case USART_CLOCKSOURCE_HSI:
      usartdiv = (uint16_t)(((2*((uint32_t)16000000)) + (husart->Init.BaudRate/2))/ husart->Init.BaudRate);
      break;
    case USART_CLOCKSOURCE_SYSCLK:
      usartdiv = (uint16_t)(((2*HAL_RCC_GetSysClockFreq()) + (husart->Init.BaudRate/2))/ husart->Init.BaudRate);
      break;
    case USART_CLOCKSOURCE_LSE:
      usartdiv = (uint16_t)(((2*((uint32_t)32768)) + (husart->Init.BaudRate/2))/ husart->Init.BaudRate);
      break;
...
static HAL_StatusTypeDef USART_CheckIdleState(USART_HandleTypeDef *husart)
{
  ...
  if((husart->Instance->CR1 & (0x1U << (3U))) == (0x1U << (3U)))
  {

    if(USART_WaitOnFlagUntilTimeout(husart, (0x1U << (21U)), RESET, tickstart, ((uint32_t) 1000U)) != HAL_OK)
    {
