...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rcc.c" 2
...
# 86 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rcc.c" 2
...
# 542 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rcc.c"
        (((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->PLLCFGR = (0x20000000 | (RCC_OscInitStruct->PLL.PLLSource) | (RCC_OscInitStruct->PLL.PLLM)| ((RCC_OscInitStruct->PLL.PLLN) << (6U)) | ((((RCC_OscInitStruct->PLL.PLLP) >> 1) -1) << (16U)) | ((RCC_OscInitStruct->PLL.PLLQ) << (24U))));
  ...
  switch (((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->CFGR & (0x3U << (2U)))
  {
    ...
    case 0x00000008U:
    {
      ...
      if (((uint32_t)(((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->PLLCFGR & (0x1U << (22U)))) != 0x00000000U)
      {
        ...
        pllvco = ((((uint32_t)8000000) / pllm) * ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->PLLCFGR & (0x1FFU << (6U))) >> (6U)));
      }
      else
      {

        pllvco = ((((uint32_t)16000000) / pllm) * ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->PLLCFGR & (0x1FFU << (6U))) >> (6U)));
      }
