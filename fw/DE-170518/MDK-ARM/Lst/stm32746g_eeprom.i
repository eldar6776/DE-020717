# 1 "../Drivers/BSP/STM32F746/stm32746g_eeprom.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 370 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/BSP/STM32F746/stm32746g_eeprom.c" 2
# 92 "../Drivers/BSP/STM32F746/stm32746g_eeprom.c"
# 1 "../Drivers/BSP/STM32F746/stm32746g_eeprom.h" 1
# 46 "../Drivers/BSP/STM32F746/stm32746g_eeprom.h"
...
# 47 "../Drivers/BSP/STM32F746/stm32746g_eeprom.h" 2
# 96 "../Drivers/BSP/STM32F746/stm32746g_eeprom.h"
...
# 93 "../Drivers/BSP/STM32F746/stm32746g_eeprom.c" 2
# 131 "../Drivers/BSP/STM32F746/stm32746g_eeprom.c"
volatile uint16_t EEPROMAddress = 0;
volatile uint16_t EEPROMDataRead;
volatile uint8_t EEPROMDataWrite;
# 158 "../Drivers/BSP/STM32F746/stm32746g_eeprom.c"
uint32_t BSP_EEPROM_Init(void)
{
  ...
  EEPROMAddress = ((uint16_t)0xA0);
  if(EEPROM_IO_IsDeviceReady(EEPROMAddress, ((uint32_t)3000)) != HAL_OK)
  {

    EEPROMAddress = ((uint16_t)0xA6);
    if(EEPROM_IO_IsDeviceReady(EEPROMAddress, ((uint32_t)3000)) != HAL_OK)
    {
      return ((uint32_t)1);
    }
...
# 202 "../Drivers/BSP/STM32F746/stm32746g_eeprom.c"
uint32_t BSP_EEPROM_ReadBuffer(uint8_t* pBuffer, uint16_t ReadAddr, uint16_t* NumByteToRead)
{
...
# 249 "../Drivers/BSP/STM32F746/stm32746g_eeprom.c"
uint32_t BSP_EEPROM_WritePage(uint8_t* pBuffer, uint16_t WriteAddr, uint8_t* NumByteToWrite)
{
  ...
  if(BSP_EEPROM_WaitEepromStandbyState() != ((uint32_t)0))
  {
    return ((uint32_t)1);
  }
...
# 284 "../Drivers/BSP/STM32F746/stm32746g_eeprom.c"
uint32_t BSP_EEPROM_WriteBuffer(uint8_t *pBuffer, uint16_t WriteAddr, uint16_t NumByteToWrite)
{
  ...
  addr = WriteAddr % ((uint8_t)4);
  count = ((uint8_t)4) - addr;
  numofpage = NumByteToWrite / ((uint8_t)4);
  numofsingle = NumByteToWrite % ((uint8_t)4);
...
# 441 "../Drivers/BSP/STM32F746/stm32746g_eeprom.c"
uint32_t BSP_EEPROM_WaitEepromStandbyState(void)
{
...
__attribute__((weak)) void BSP_EEPROM_TIMEOUT_UserCallback(void)
{
}
