...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc.c" 2
...
# 194 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc.c" 2
...
HAL_StatusTypeDef HAL_ADC_Init(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc->Init.ExternalTrigConv != ((uint32_t)(0xFU << (24U)) + 1))
  {
    ((void)0U);
  }
...
# 726 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc.c"
HAL_StatusTypeDef HAL_ADC_Start_IT(ADC_HandleTypeDef* hadc)
{
  volatile uint32_t counter = 0;
...
HAL_StatusTypeDef HAL_ADC_ConfigChannel(ADC_HandleTypeDef* hadc, ADC_ChannelConfTypeDef* sConfig)
{
 ...
 if (sConfig->Channel > ((uint32_t)((0x08U << (0U)) | (0x01U << (0U)))))
 {
  ...
  hadc->Instance->SMPR1 &= ~(((0x7U << (0U))) << (3 * (((uint32_t)((uint16_t)(sConfig->Channel))) - 10)));

  if (sConfig->Channel == ((uint32_t)((uint32_t)((0x10U << (0U)) | (0x02U << (0U)))) | 0x10000000U))
  {

   hadc->Instance->SMPR1 |= ((sConfig->SamplingTime) << (3 * (((uint32_t)((uint16_t)(((uint32_t)((0x10U << (0U)) | (0x02U << (0U))))))) - 10)));
  }
   else
   {

    hadc->Instance->SMPR1 |= ((sConfig->SamplingTime) << (3 * (((uint32_t)((uint16_t)(sConfig->Channel))) - 10)));
   }
  }
  else
  {

    hadc->Instance->SMPR2 &= ~(((0x7U << (0U))) << (3 * ((uint32_t)((uint16_t)(sConfig->Channel)))));


    hadc->Instance->SMPR2 |= ((sConfig->SamplingTime) << (3 * ((uint32_t)((uint16_t)(sConfig->Channel)))));
  }
  ...
  if (sConfig->Rank < 7)
  {
    ...
    hadc->Instance->SQR3 &= ~(((uint32_t)((uint16_t)((0x1FU << (0U))))) << (5 * ((sConfig->Rank) - 1)));


    hadc->Instance->SQR3 |= (((uint32_t)((uint16_t)(sConfig->Channel))) << (5 * ((sConfig->Rank) - 1)));
  }

  else if (sConfig->Rank < 13)
  {

    hadc->Instance->SQR2 &= ~(((uint32_t)((uint16_t)((0x1FU << (0U))))) << (5 * ((sConfig->Rank) - 7)));


    hadc->Instance->SQR2 |= (((uint32_t)((uint16_t)(sConfig->Channel))) << (5 * ((sConfig->Rank) - 7)));
  }

  else
  {

    hadc->Instance->SQR1 &= ~(((uint32_t)((uint16_t)((0x1FU << (0U))))) << (5 * ((sConfig->Rank) - 13)));


    hadc->Instance->SQR1 |= (((uint32_t)((uint16_t)(sConfig->Channel))) << (5 * ((sConfig->Rank) - 13)));
  }
  ...
  if ((hadc->Instance == ((ADC_TypeDef *) ((0x40000000U + 0x00010000U) + 0x2000U))) && ((sConfig->Channel == ((uint32_t)((uint32_t)((0x10U << (0U)) | (0x02U << (0U)))) | 0x10000000U)) || (sConfig->Channel == ((uint32_t)((uint32_t)((0x10U << (0U)) | (0x01U << (0U))))))))
  {
    ...
    if(sConfig->Channel == ((uint32_t)((uint32_t)((0x10U << (0U)) | (0x02U << (0U)))) | 0x10000000U))
    {
      ...
      counter = (((uint32_t) 10U) * (SystemCoreClock / 1000000));
      while(counter != 0)
      {
        counter--;
      }
...
# 1473 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc.c"
uint32_t HAL_ADC_GetState(ADC_HandleTypeDef* hadc)
{
...
static void ADC_Init(ADC_HandleTypeDef* hadc)
{
  ...
  hadc->Instance->CR1 |= ((hadc->Init.ScanConvMode) << 8);
  ...
  hadc->Instance->CR2 |= ((hadc->Init.ContinuousConvMode) << 1);
  ...
  if(hadc->Init.DiscontinuousConvMode != DISABLE)
  {
    ...
    hadc->Instance->CR1 |= (((hadc->Init.NbrOfDiscConversion) - 1) << (13U));
  }
  else
  {
  ...
  hadc->Instance->SQR1 |= (((hadc->Init.NbrOfConversion) - (uint8_t)1) << 20);


  hadc->Instance->CR2 &= ~((0x1U << (9U)));
  hadc->Instance->CR2 |= ((hadc->Init.DMAContinuousRequests) << 9);


  hadc->Instance->CR2 &= ~((0x1U << (10U)));
  hadc->Instance->CR2 |= ((hadc->Init.EOCSelection) << 10);
}
