...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash_ex.c" 2
...
# 74 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash_ex.c" 2
    ...
    *SectorError = 0xFFFFFFFFU;
    ...
    else
    {
      ...
      for(index = pEraseInit->Sector; index < (pEraseInit->NbSectors + pEraseInit->Sector); index++)
      {
        ...
        ((((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->CR) &= ~(((0x1U << (1U)) | (0xFU << (3U)))));
...
# 247 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash_ex.c"
HAL_StatusTypeDef HAL_FLASHEx_Erase_IT(FLASH_EraseInitTypeDef *pEraseInit)
{
...
# 657 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash_ex.c"
static void FLASH_MassErase(uint8_t VoltageRange)
{
...
void FLASH_Erase_Sector(uint32_t Sector, uint8_t VoltageRange)
{
  ...
  ((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->CR &= 0xFFFFFF07U;
...
static uint32_t FLASH_OB_GetWRP(void)
{
  ...
  return ((uint32_t)(((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->OPTCR & 0x00FF0000));
}
...
static HAL_StatusTypeDef FLASH_OB_UserConfig(uint32_t Wwdg, uint32_t Iwdg, uint32_t Stop, uint32_t Stdby, uint32_t Iwdgstop, uint32_t Iwdgstdby)
{
  ...
  if(status == HAL_OK)
  {
    useroptionmask = ((0x1U << (4U)) | (0x1U << (5U)) | (0x1U << (6U)) | (0x1U << (7U)) | (0x1U << (31U)) | (0x1U << (30U)));
...
static uint32_t FLASH_OB_GetUser(void)
{
  ...
  return ((uint32_t)(((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->OPTCR & 0xC00000F0U));
}
...
# 919 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash_ex.c"
static HAL_StatusTypeDef FLASH_OB_BOR_LevelConfig(uint8_t Level)
{
...
# 1011 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash_ex.c"
static uint32_t FLASH_OB_GetBOR(void)
{
