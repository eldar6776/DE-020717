...
# 34 "../Src/thermostat.c"
volatile uint32_t thermostat_timer;
volatile uint32_t thermostat_fan_timer;
volatile uint32_t thermostat_valve_timer;
...
void THERMOSTAT_Init(void)
{
 ...
 HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0800U)), ((uint16_t)0x0400U)|((uint16_t)0x0800U)|((uint16_t)0x1000U), GPIO_PIN_RESET);
 HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0C00U)), ((uint16_t)0x0004U)|((uint16_t)0x0010U), GPIO_PIN_RESET);

    GPIO_InitStruct.Pin = ((uint16_t)0x0400U)|((uint16_t)0x0800U)|((uint16_t)0x1000U);
 ...
 GPIO_InitStruct.Pin = ((uint16_t)0x0004U)|((uint16_t)0x0010U);
    GPIO_InitStruct.Mode = ((uint32_t)0x00000001U);
    GPIO_InitStruct.Pull = ((uint32_t)0x00000001U);
    GPIO_InitStruct.Speed = ((uint32_t)0x00000000U);
 ...
 Thermostat_1.fan_mode = 0;
 Thermostat_1.fan_speed = 0;
 Thermostat_1.ctrl_mode = 0;
 Thermostat_1.actual_temperature = 210;
 Thermostat_1.set_temperature = 210;
 Thermostat_1.set_temperature_diff = 15;
 Thermostat_1.fan_low_speed_band = 10;
 Thermostat_1.fan_middle_speed_band = 20;
 Thermostat_1.fan_speed_diff = 3;
}
...
void THERMOSTAT_Service(void)
{
 ...
 if(Thermostat_1.fan_speed != old_fan_speed)
 {
  if((fan_pcnt == 0) && (thermostat_fan_timer == 0))
  {
   (HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0800U)), ((uint16_t)0x0400U)|((uint16_t)0x0800U)|((uint16_t)0x1000U), GPIO_PIN_RESET));
   (FAN_SetSpeed(0));
   if(old_fan_speed != 0) (thermostat_fan_timer = 1560);
   fan_pcnt++;
  }
  else if((fan_pcnt == 1) && (thermostat_fan_timer == 0))
  {
   if(Thermostat_1.fan_speed == 1)
   {
    (HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0800U)), ((uint16_t)0x0400U), GPIO_PIN_SET));
    (FAN_SetSpeed(52));
   }
   else if(Thermostat_1.fan_speed == 2)
   {
    (HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0800U)), ((uint16_t)0x0800U), GPIO_PIN_SET));
    (FAN_SetSpeed(47));
   }
   else if(Thermostat_1.fan_speed == 3)
   {
    (HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0800U)), ((uint16_t)0x1000U), GPIO_PIN_SET));
    (FAN_SetSpeed(42));
   }

   if(Thermostat_1.fan_speed != 0) (thermostat_fan_timer = 1560);
 ...
 if(Thermostat_1.valve != Thermostat_1.ctrl_mode)
 {
  if((thermostat_valve_timer == 0))
  {
   if(Thermostat_1.ctrl_mode == 1) (HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0C00U)), ((uint16_t)0x0004U), GPIO_PIN_SET));
   else (HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0C00U)), ((uint16_t)0x0004U), GPIO_PIN_RESET));
   (thermostat_valve_timer = 5678);
 ...
 else if(Thermostat_1.ctrl_mode == 1)
 {
  if(Thermostat_1.fan_mode == 0)
  {
  ...
  else if(Thermostat_1.fan_mode > 0)
  {
 ...
 else if(Thermostat_1.ctrl_mode == 2)
 {
  if(Thermostat_1.fan_mode == 0)
  {
   if((Thermostat_1.fan_speed == 0) &&
