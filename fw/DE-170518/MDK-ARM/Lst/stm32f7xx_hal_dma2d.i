...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_dma2d.c" 2
...
# 128 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_dma2d.c" 2
# 167 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_dma2d.c"
...
# 261 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_dma2d.c"
HAL_StatusTypeDef HAL_DMA2D_DeInit(DMA2D_HandleTypeDef *hdma2d)
{
  ...
  do{ (hdma2d)->Lock = HAL_UNLOCKED; }while (0);
...
__attribute__((weak)) void HAL_DMA2D_MspInit(DMA2D_HandleTypeDef* hdma2d)
{
...
__attribute__((weak)) void HAL_DMA2D_MspDeInit(DMA2D_HandleTypeDef* hdma2d)
{
...
HAL_StatusTypeDef HAL_DMA2D_Start(DMA2D_HandleTypeDef *hdma2d, uint32_t pdata, uint32_t DstAddress, uint32_t Width, uint32_t Height)
{
  ...
  do{ if((hdma2d)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (hdma2d)->Lock = HAL_LOCKED; } }while (0);
...
# 452 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_dma2d.c"
HAL_StatusTypeDef HAL_DMA2D_Start_IT(DMA2D_HandleTypeDef *hdma2d, uint32_t pdata, uint32_t DstAddress, uint32_t Width, uint32_t Height)
{
...
# 487 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_dma2d.c"
HAL_StatusTypeDef HAL_DMA2D_BlendingStart(DMA2D_HandleTypeDef *hdma2d, uint32_t SrcAddress1, uint32_t SrcAddress2, uint32_t DstAddress, uint32_t Width, uint32_t Height)
{
...
# 682 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_dma2d.c"
HAL_StatusTypeDef HAL_DMA2D_EnableCLUT(DMA2D_HandleTypeDef *hdma2d, uint32_t LayerIdx)
{
...
{
  uint32_t tickstart = 0;
  volatile uint32_t * reg = &(hdma2d->Instance->BGPFCCR);
...
__attribute__((weak)) void HAL_DMA2D_LineEventCallback(DMA2D_HandleTypeDef *hdma2d)
{
...
__attribute__((weak)) void HAL_DMA2D_CLUTLoadingCpltCallback(DMA2D_HandleTypeDef *hdma2d)
{
...
# 1371 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_dma2d.c"
