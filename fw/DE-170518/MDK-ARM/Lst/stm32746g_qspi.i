# 1 "../Drivers/BSP/STM32F746/stm32746g_qspi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 370 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/BSP/STM32F746/stm32746g_qspi.c" 2
# 74 "../Drivers/BSP/STM32F746/stm32746g_qspi.c"
# 1 "../Drivers/BSP/STM32F746/stm32746g_qspi.h" 1
# 54 "../Drivers/BSP/STM32F746/stm32746g_qspi.h"
...
# 55 "../Drivers/BSP/STM32F746/stm32746g_qspi.h" 2
...
# 75 "../Drivers/BSP/STM32F746/stm32746g_qspi.c" 2
# 94 "../Drivers/BSP/STM32F746/stm32746g_qspi.c"
QSPI_HandleTypeDef hqspi;
# 107 "../Drivers/BSP/STM32F746/stm32746g_qspi.c"
static uint8_t QSPI_ResetMemory (QSPI_HandleTypeDef *hqspi);
static uint8_t QSPI_DummyCyclesCfg (QSPI_HandleTypeDef *hqspi);
static uint8_t QSPI_WriteEnable (QSPI_HandleTypeDef *hqspi);
static uint8_t QSPI_AutoPollingMemReady (QSPI_HandleTypeDef *hqspi, uint32_t Timeout);
# 124 "../Drivers/BSP/STM32F746/stm32746g_qspi.c"
uint8_t BSP_QSPI_Init(void)
{
    hqspi.Instance = ((QUADSPI_TypeDef *) 0xA0001000U);
    ...
    BSP_QSPI_MspInit(&hqspi, 0);


    hqspi.Init.ClockPrescaler = 2;
    hqspi.Init.FifoThreshold = 4;
    hqspi.Init.SampleShifting = ((uint32_t)(0x1U << (4U)));
    hqspi.Init.FlashSize = 23;
    hqspi.Init.ChipSelectHighTime = ((uint32_t)(0x1U << (8U)));
    hqspi.Init.ClockMode = ((uint32_t)0x00000000U);
    hqspi.Init.FlashID = ((uint32_t)0x00000000U);
    hqspi.Init.DualFlash = ((uint32_t)0x00000000U);
    ...
    if (QSPI_ResetMemory(&hqspi) != ((uint8_t)0x00))
    {
        return ((uint8_t)0x04);
    }


    if (QSPI_DummyCyclesCfg(&hqspi) != ((uint8_t)0x00))
    {
        return ((uint8_t)0x04);
    }

    if(BSP_QSPI_EnableMemoryMappedMode() != ((uint8_t)0x00))
    {
        return ((uint8_t)0x04);
    }
...
uint8_t BSP_QSPI_DeInit(void)
{
  ...
  BSP_QSPI_MspDeInit(&hqspi, 0);

  return ((uint8_t)0x00);
}
# 199 "../Drivers/BSP/STM32F746/stm32746g_qspi.c"
uint8_t BSP_QSPI_Read(uint8_t* pData, uint32_t ReadAddr, uint32_t Size)
{
  QSPI_CommandTypeDef s_command;


  s_command.InstructionMode = ((uint32_t)(0x1U << (8U)));
  s_command.Instruction = 0xEB;
  s_command.AddressMode = ((uint32_t)(0x3U << (10U)));
  s_command.AddressSize = ((uint32_t)(0x2U << (12U)));
  s_command.Address = ReadAddr;
  s_command.AlternateByteMode = ((uint32_t)0x00000000U);
  s_command.DataMode = ((uint32_t)(0x3U << (24U)));
  s_command.DummyCycles = 10;
  s_command.NbData = Size;
  s_command.DdrMode = ((uint32_t)0x00000000U);
  s_command.DdrHoldHalfCycle = ((uint32_t)0x00000000U);
  s_command.SIOOMode = ((uint32_t)0x00000000U);


  if (HAL_QSPI_Command(&hqspi, &s_command, ((uint32_t)5000)) != HAL_OK)
  {
    return ((uint8_t)0x01);
  }


  (((hqspi.Instance->DCR)) = ((((((hqspi.Instance->DCR))) & (~((0x7U << (8U))))) | (((uint32_t)(0x2U << (8U)))))));


  if (HAL_QSPI_Receive(&hqspi, pData, ((uint32_t)5000)) != HAL_OK)
  {
    return ((uint8_t)0x01);
  }


  (((hqspi.Instance->DCR)) = ((((((hqspi.Instance->DCR))) & (~((0x7U << (8U))))) | (((uint32_t)(0x4U << (8U)) | (0x1U << (8U)))))));

  return ((uint8_t)0x00);
}
# 245 "../Drivers/BSP/STM32F746/stm32746g_qspi.c"
uint8_t BSP_QSPI_Write(uint8_t* pData, uint32_t WriteAddr, uint32_t Size)
{
  QSPI_CommandTypeDef s_command;
  ...
  current_size = 0x100 - (WriteAddr % 0x100);
  ...
  do
  {
    ...
    if (QSPI_WriteEnable(&hqspi) != ((uint8_t)0x00))
    {
      return ((uint8_t)0x01);
    }
    ...
    if (HAL_QSPI_Transmit(&hqspi, pData, ((uint32_t)5000)) != HAL_OK)
    {
      return ((uint8_t)0x01);
    }


    if (QSPI_AutoPollingMemReady(&hqspi, ((uint32_t)5000)) != ((uint8_t)0x00))
    {
      return ((uint8_t)0x01);
    }
...
uint8_t BSP_QSPI_Erase_Block(uint32_t BlockAddress)
{
  ...
  s_command.AddressMode = ((uint32_t)(0x1U << (10U)));
  s_command.AddressSize = ((uint32_t)(0x2U << (12U)));
  s_command.Address = BlockAddress;
  s_command.AlternateByteMode = ((uint32_t)0x00000000U);
  s_command.DataMode = ((uint32_t)0X00000000);
  s_command.DummyCycles = 0;
  s_command.DdrMode = ((uint32_t)0x00000000U);
  s_command.DdrHoldHalfCycle = ((uint32_t)0x00000000U);
  s_command.SIOOMode = ((uint32_t)0x00000000U);
  ...
  if (QSPI_AutoPollingMemReady(&hqspi, 800) != ((uint8_t)0x00))
  {
    return ((uint8_t)0x01);
  }
...
uint8_t BSP_QSPI_Erase_Chip(void)
{
  ...
  s_command.AddressMode = ((uint32_t)0x00000000U);
  s_command.AlternateByteMode = ((uint32_t)0x00000000U);
  s_command.DataMode = ((uint32_t)0X00000000);
  s_command.DummyCycles = 0;
  s_command.DdrMode = ((uint32_t)0x00000000U);
  ...
  if (QSPI_AutoPollingMemReady(&hqspi, 250000) != ((uint8_t)0x00))
  {
    return ((uint8_t)0x01);
  }
...
uint8_t BSP_QSPI_GetStatus(void)
{
  ...
  s_command.AddressMode = ((uint32_t)0x00000000U);
  s_command.AlternateByteMode = ((uint32_t)0x00000000U);
  s_command.DataMode = ((uint32_t)(0x1U << (24U)));
  s_command.DummyCycles = 0;
  s_command.NbData = 1;
  s_command.DdrMode = ((uint32_t)0x00000000U);
  s_command.DdrHoldHalfCycle = ((uint32_t)0x00000000U);
  ...
  if (HAL_QSPI_Receive(&hqspi, &reg, ((uint32_t)5000)) != HAL_OK)
  {
    return ((uint8_t)0x01);
  }


  if ((reg & (((uint8_t)0x02) | ((uint8_t)0x08) | ((uint8_t)0x10) | ((uint8_t)0x20))) != 0)
  {
    return ((uint8_t)0x01);
  }
  else if ((reg & (((uint8_t)0x04) | ((uint8_t)0x40))) != 0)
  {
    return ((uint8_t)0x08);
  }
  else if ((reg & ((uint8_t)0x80)) != 0)
  {
    return ((uint8_t)0x00);
  }
  else
...
uint8_t BSP_QSPI_GetInfo(QSPI_Info* pInfo)
{
  ...
  pInfo->FlashSize = 0x1000000;
  pInfo->EraseSectorSize = 0x1000;
  pInfo->EraseSectorsNumber = (0x1000000/0x1000);
  pInfo->ProgPageSize = 0x100;
  pInfo->ProgPagesNumber = (0x1000000/0x100);
...
uint8_t BSP_QSPI_EnableMemoryMappedMode(void)
{
    ...
    s_mem_mapped_cfg.TimeOutActivation = ((uint32_t)0x00000000U);
...
# 515 "../Drivers/BSP/STM32F746/stm32746g_qspi.c"
__attribute__((weak)) void BSP_QSPI_MspInit(QSPI_HandleTypeDef *hqspi, void *Params)
{
  GPIO_InitTypeDef GPIO_InitStruct;



  do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB3ENR) |= ((0x1U << (1U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB3ENR) & ((0x1U << (1U)))); ((void)(tmpreg)); } while(0);

  (((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB3RSTR |= ((0x1U << (1U))));
  (((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB3RSTR &= ~((0x1U << (1U))));
  ...
  GPIO_InitStruct.Alternate = ((uint8_t)0xAU);
...
# 581 "../Drivers/BSP/STM32F746/stm32746g_qspi.c"
__attribute__((weak)) void BSP_QSPI_MspDeInit(QSPI_HandleTypeDef *hqspi, void *Params)
{
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U)), ((uint16_t)0x0040U));
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U)), ((uint16_t)0x0004U));
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1400U)), ((uint16_t)0x0100U));
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1400U)), ((uint16_t)0x0200U));
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1400U)), ((uint16_t)0x0080U));
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1400U)), ((uint16_t)0x0040U));
    ...
    (((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB3ENR &= ~((0x1U << (1U))));
}
...
static uint8_t QSPI_DummyCyclesCfg(QSPI_HandleTypeDef *hqspi)
{
    ...
    (((reg)) = ((((((reg))) & (~(((uint8_t)0xF0)))) | ((10 << ((uint8_t)__builtin_clz(__builtin_arm_rbit(((uint8_t)0xF0)))))))));
    ...
    if (HAL_QSPI_Transmit(hqspi, &reg, ((uint32_t)5000)) != HAL_OK)
    {
        return ((uint8_t)0x01);
    }
...
static uint8_t QSPI_WriteEnable(QSPI_HandleTypeDef *hqspi)
{
    ...
    s_config.Match = ((uint8_t)0x02);
    s_config.Mask = ((uint8_t)0x02);
    s_config.MatchMode = ((uint32_t)0x00000000U);
    s_config.StatusBytesSize = 1;
    s_config.Interval = 0x10;
    s_config.AutomaticStop = ((uint32_t)(0x1U << (22U)));

    s_command.Instruction = 0x05;
    s_command.DataMode = ((uint32_t)(0x1U << (24U)));
    s_command.NbData = 1;

    if (HAL_QSPI_AutoPolling(hqspi, &s_command, &s_config, ((uint32_t)5000)) != HAL_OK)
    {
        return ((uint8_t)0x01);
    }
