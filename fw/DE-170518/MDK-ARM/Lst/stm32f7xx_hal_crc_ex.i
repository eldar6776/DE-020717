...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_crc_ex.c" 2
...
# 53 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_crc_ex.c" 2
...
# 121 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_crc_ex.c"
  ...
  switch (PolyLength)
  {
    case ((uint32_t)(0x3U << (3U))):
      if (msb >= 7U)
      {
        return HAL_ERROR;
      }
      break;
    case ((uint32_t)(0x2U << (3U))):
      if (msb >= 8U)
      {
        return HAL_ERROR;
      }
      break;
    case ((uint32_t)(0x1U << (3U))):
      if (msb >= 16U)
      {
        return HAL_ERROR;
      }
  ...
  (((hcrc->Instance->CR)) = ((((((hcrc->Instance->CR))) & (~((0x3U << (3U))))) | (PolyLength))));


  return HAL_OK;
}
# 173 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_crc_ex.c"
HAL_StatusTypeDef HAL_CRCEx_Input_Data_Reverse(CRC_HandleTypeDef *hcrc, uint32_t InputReverseMode)
{
  ...
  (((hcrc->Instance->CR)) = ((((((hcrc->Instance->CR))) & (~((0x3U << (5U))))) | (InputReverseMode))));
...
# 199 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_crc_ex.c"
HAL_StatusTypeDef HAL_CRCEx_Output_Data_Reverse(CRC_HandleTypeDef *hcrc, uint32_t OutputReverseMode)
{
  ...
  (((hcrc->Instance->CR)) = ((((((hcrc->Instance->CR))) & (~((0x1U << (7U))))) | (OutputReverseMode))));
