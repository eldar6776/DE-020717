...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc_ex.c" 2
# 115 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc_ex.c"
...
# 116 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc_ex.c" 2
...
HAL_StatusTypeDef HAL_ADCEx_InjectedStart(ADC_HandleTypeDef* hadc)
{
  ...
  if((hadc->Instance->CR2 & (0x1U << (0U))) != (0x1U << (0U)))
  {
    ...
    counter = (((uint32_t) 3U) * (SystemCoreClock / 1000000));
    while(counter != 0)
    {
      counter--;
    }
  ...
  if((((hadc->Instance->CR2) & ((0x1U << (0U)))) != RESET))
  {
    ...
    if((((((ADC_Common_TypeDef *) ((0x40000000U + 0x00010000U) + 0x2300U))->CCR) & ((0x1FU << (0U)))) == RESET))
    {
...
# 361 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc_ex.c"
HAL_StatusTypeDef HAL_ADCEx_InjectedStop(ADC_HandleTypeDef* hadc)
{
...
HAL_StatusTypeDef HAL_ADCEx_MultiModeStart_DMA(ADC_HandleTypeDef* hadc, uint32_t* pData, uint32_t Length)
{
  ...
  if((((hadc->Instance->CR2) & ((0x1U << (0U)))) != RESET))
  {
    ...
    if (hadc->Init.DMAContinuousRequests != DISABLE)
    {
      ...
      ((ADC_Common_TypeDef *) ((0x40000000U + 0x00010000U) + 0x2300U))->CCR |= (0x1U << (13U));
    }
    else
    {
...
# 755 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc_ex.c"
uint32_t HAL_ADCEx_MultiModeGetValue(ADC_HandleTypeDef* hadc)
{
...
# 784 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc_ex.c"
HAL_StatusTypeDef HAL_ADCEx_InjectedConfigChannel(ADC_HandleTypeDef* hadc, ADC_InjectionConfTypeDef* sConfigInjected)
{
  ...
  if(sConfigInjected->ExternalTrigInjecConv != ((uint32_t)(0xFU << (16U)) + 1))
  {
    ((void)0U);
  }
  ...
  if (sConfigInjected->InjectedChannel > ((uint32_t)((0x08U << (0U)) | (0x01U << (0U)))))
  {
    ...
    hadc->Instance->SMPR1 &= ~(((0x7U << (0U))) << (3 * (((uint32_t)((uint16_t)(sConfigInjected->InjectedChannel))) - 10)));


    hadc->Instance->SMPR1 |= ((sConfigInjected->InjectedSamplingTime) << (3 * (((uint32_t)((uint16_t)(sConfigInjected->InjectedChannel))) - 10)));
  }
  else
  {

    hadc->Instance->SMPR2 &= ~(((0x7U << (0U))) << (3 * ((uint32_t)((uint16_t)(sConfigInjected->InjectedChannel)))));


    hadc->Instance->SMPR2 |= ((sConfigInjected->InjectedSamplingTime) << (3 * ((uint32_t)((uint16_t)(sConfigInjected->InjectedChannel)))));
  }


  hadc->Instance->JSQR &= ~((0x3U << (20U)));
  hadc->Instance->JSQR |= (((sConfigInjected->InjectedNbrOfConversion) - (uint8_t)1) << 20);




  hadc->Instance->JSQR &= ~(((uint32_t)((uint16_t)((0x1FU << (0U))))) << (5 * (uint8_t)(((sConfigInjected->InjectedRank) + 3) - (sConfigInjected->InjectedNbrOfConversion))));


  hadc->Instance->JSQR |= (((uint32_t)((uint16_t)(sConfigInjected->InjectedChannel))) << (5 * (uint8_t)(((sConfigInjected->InjectedRank) + 3) - (sConfigInjected->InjectedNbrOfConversion))));
  ...
  if ((hadc->Instance == ((ADC_TypeDef *) ((0x40000000U + 0x00010000U) + 0x2000U))) && ((sConfigInjected->InjectedChannel == ((uint32_t)((uint32_t)((0x10U << (0U)) | (0x02U << (0U)))) | 0x10000000U)) || (sConfigInjected->InjectedChannel == ((uint32_t)((uint32_t)((0x10U << (0U)) | (0x01U << (0U))))))))
  {
...
HAL_StatusTypeDef HAL_ADCEx_MultiModeConfigChannel(ADC_HandleTypeDef* hadc, ADC_MultiModeTypeDef* multimode)
{
  ...
  ((ADC_Common_TypeDef *) ((0x40000000U + 0x00010000U) + 0x2300U))->CCR &= ~((0x1FU << (0U)));
  ((ADC_Common_TypeDef *) ((0x40000000U + 0x00010000U) + 0x2300U))->CCR |= multimode->Mode;


  ((ADC_Common_TypeDef *) ((0x40000000U + 0x00010000U) + 0x2300U))->CCR &= ~((0x3U << (14U)));
  ((ADC_Common_TypeDef *) ((0x40000000U + 0x00010000U) + 0x2300U))->CCR |= multimode->DMAAccessMode;


  ((ADC_Common_TypeDef *) ((0x40000000U + 0x00010000U) + 0x2300U))->CCR &= ~((0xFU << (8U)));
...
# 979 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc_ex.c"
static void ADC_MultiModeDMAConvCplt(DMA_HandleTypeDef *hdma)
{
