...
/** ============================================================================*/
#define FANCOIL_FanLowSpeedOn()				(HAL_GPIO_WritePin(GPIOF, GPIO_PIN_6, GPIO_PIN_SET))
#define FANCOIL_FanLowSpeedOff()			(HAL_GPIO_WritePin(GPIOF, GPIO_PIN_6, GPIO_PIN_RESET))
#define FANCOIL_FanMiddleSpeedOn()			(HAL_GPIO_WritePin(GPIOF, GPIO_PIN_7, GPIO_PIN_SET))
#define FANCOIL_FanMiddleSpeedOff()			(HAL_GPIO_WritePin(GPIOF, GPIO_PIN_7, GPIO_PIN_RESET))
#define FANCOIL_FanHighSpeedOn()			(HAL_GPIO_WritePin(GPIOF, GPIO_PIN_8, GPIO_PIN_SET))
#define FANCOIL_FanHighSpeedOff()			(HAL_GPIO_WritePin(GPIOF, GPIO_PIN_8, GPIO_PIN_RESET))	
#define FANCOIL_FanOff()					(HAL_GPIO_WritePin(GPIOF, GPIO_PIN_6|GPIO_PIN_7|GPIO_PIN_8, GPIO_PIN_RESET))
#define FANCOIL_CoolValveOn()				(HAL_GPIO_WritePin(GPIOF, GPIO_PIN_9, GPIO_PIN_SET))
#define FANCOIL_CoolValveOff()				(HAL_GPIO_WritePin(GPIOF, GPIO_PIN_9, GPIO_PIN_RESET))
